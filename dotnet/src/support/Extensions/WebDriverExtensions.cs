...
public static class WebDriverExtensions
{
    ...
    public static void ExecuteJavaScript(this IWebDriver driver, [StringSyntax("javascript")] string script, params object?[] args)
    {
    ...
    public static T? ExecuteJavaScript<T>(this IWebDriver driver, [StringSyntax("javascript")] string script, params object?[] args)
    {
