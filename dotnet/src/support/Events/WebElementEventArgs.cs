...
public class WebElementEventArgs(IWebDriver driver, IWebElement element) : EventArgs
{
    ...
    /// </summary>
    public IWebElement Element { get; } = element ?? throw new ArgumentNullException(nameof(element));
}
