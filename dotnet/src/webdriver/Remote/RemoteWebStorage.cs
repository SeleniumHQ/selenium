...
namespace OpenQA.Selenium.Remote.HTML5
{
    ...
    public class RemoteWebStorage : IWebStorage
    {
        ...
        /// <summary>
        /// Returns local storage instance for current driver
        /// </summary>
        /// <returns>A <see cref="ILocalStorage">local storage</see> instance for current driver</returns>
        ...
        /// <summary>
        /// Returns session storage instance for current driver
        /// </summary>
        /// <returns>A <see cref="ISessionStorage">local storage</see> instance for current driver</returns>
