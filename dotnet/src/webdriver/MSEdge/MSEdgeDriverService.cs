// <copyright file="MSEdgeDriverService.cs" company="WebDriver Committers">
...
namespace OpenQA.Selenium.MSEdge
{
    ...
    /// </summary>
    public sealed class MSEdgeDriverService : DriverService
    {
        private const string DefaultMSEdgeDriverServiceExecutableName = "msedgedriver";

        private static readonly Uri MSEdgeDriverDownloadUrl = new Uri("https://msedgecdn.azurewebsites.net/webdriver/index.html");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MSEdgeDriverService"/> class.
        /// </summary>
        /// <param name="executablePath">The full path to the MSEdgeDriver executable.</param>
        /// <param name="executableFileName">The file name of the MSEdgeDriver executable.</param>
        /// <param name="port">The port on which the MSEdgeDriver executable should listen.</param>
        private MSEdgeDriverService(string executablePath, string executableFileName, int port)
            : base(executablePath, port, executableFileName, MSEdgeDriverDownloadUrl)
        {
        }

        /// <summary>
        /// Gets or sets the location of the log file written to by the MSEdgeDriver executable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to enable verbose logging for the MSEdgeDriver executable.
        ...
        /// <summary>
        /// Creates a default instance of the MSEdgeDriverService.
        /// </summary>
        /// <returns>A MSEdgeDriverService that implements default settings.</returns>
        public static MSEdgeDriverService CreateDefaultService()
        {
            string serviceDirectory = DriverService.FindDriverServiceExecutable(MSEdgeDriverServiceFileName(), MSEdgeDriverDownloadUrl);
            return CreateDefaultService(serviceDirectory);
        }

        /// <summary>
        /// Creates a default instance of the MSEdgeDriverService using a specified path to the MSEdgeDriver executable.
        /// </summary>
        /// <param name="driverPath">The directory containing the MSEdgeDriver executable.</param>
        /// <returns>A MSEdgeDriverService using a random port.</returns>
        public static MSEdgeDriverService CreateDefaultService(string driverPath)
        {
            return CreateDefaultService(driverPath, MSEdgeDriverServiceFileName());
        }

        /// <summary>
        /// Creates a default instance of the MSEdgeDriverService using a specified path to the MSEdgeDriver executable with the given name.
        /// </summary>
        /// <param name="driverPath">The directory containing the MSEdgeDriver executable.</param>
        /// <param name="driverExecutableFileName">The name of the MSEdgeDriver executable file.</param>
        /// <returns>A MSEdgeDriverService using a random port.</returns>
        public static MSEdgeDriverService CreateDefaultService(string driverPath, string driverExecutableFileName)
        {
            return new MSEdgeDriverService(driverPath, driverExecutableFileName, PortUtilities.FindFreePort());
        }
        ...
        private static string MSEdgeDriverServiceFileName()
        {
            string fileName = DefaultMSEdgeDriverServiceExecutableName;
