// <copyright file="JavaScriptExceptionThrownEventArgs.cs" company="Selenium Committers">
...
public class JavaScriptExceptionThrownEventArgs(string message) : EventArgs
{
