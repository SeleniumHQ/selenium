...
if [[ ! -f "$1../../../bazel-bin/dotnet/src/webdriver/generated/v84/DevToolsSessionDomains.cs" ]]
then
  echo "Generating CDP code for version 84"
  bazel build //dotnet/src/webdriver/DevTools:generate-v84
fi

if [[ ! -f "$1../../../bazel-bin/dotnet/src/webdriver/generated/v85/DevToolsSessionDomains.cs" ]]
then
  echo "Generating CDP code for version 85"
  bazel build //dotnet/src/webdriver/DevTools:generate-v85
fi

if [[ ! -f "$1../../../bazel-bin/dotnet/src/webdriver/generated/v86/DevToolsSessionDomains.cs" ]]
then
