// <copyright file="WebSocketConnectionDataReceivedEventArgs.cs" company="Selenium Committers">
...
public class WebSocketConnectionDataReceivedEventArgs(string data) : EventArgs
{
