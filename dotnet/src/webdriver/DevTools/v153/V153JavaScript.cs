// <copyright file="V153JavaScript.cs" company="Selenium Committers">
...
/// <summary>
/// Class containing the JavaScript implementation for version 153 of the DevTools Protocol.
/// </summary>
public class V153JavaScript : JavaScript
{
    private readonly RuntimeAdapter runtime;
    private readonly PageAdapter page;

    /// <summary>
    /// Initializes a new instance of the <see cref="V153JavaScript"/> class.
    /// </summary>
    ...
    public V153JavaScript(RuntimeAdapter runtime, PageAdapter page)
    {
