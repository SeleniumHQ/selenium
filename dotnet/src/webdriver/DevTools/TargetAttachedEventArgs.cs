...
public class TargetAttachedEventArgs(string sessionId, TargetInfo? targetInfo, bool waitingForDebugger) : EventArgs
{
    ...
    /// </summary>
    public bool WaitingForDebugger { get; } = waitingForDebugger;
}
