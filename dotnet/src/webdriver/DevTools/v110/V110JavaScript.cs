// <copyright file="V110JavaScript.cs" company="WebDriver Committers">
...
namespace OpenQA.Selenium.DevTools.V110
{
    ...
    /// </summary>
    public class V110JavaScript : JavaScript
    {
        private RuntimeAdapter runtime;
        private PageAdapter page;

        /// <summary>
        /// Initializes a new instance of the <see cref="V110JavaScript"/> class.
        /// </summary>
        /// <param name="runtime">The DevTools Protocol adapter for the Runtime domain.</param>
        /// <param name="page">The DevTools Protocol adapter for the Page domain.</param>
        public V110JavaScript(RuntimeAdapter runtime, PageAdapter page)
        {
