// <copyright file="V111Target.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Class providing functionality for manipulating targets for version 111 of the DevTools Protocol
    /// </summary>
    public class V111Target : DevTools.Target
    {
        private TargetAdapter adapter;

        /// <summary>
        /// Initializes a new instance of the <see cref="V111Target"/> class.
        /// </summary>
        /// <param name="adapter">The adapter for the Target domain.</param>
        public V111Target(TargetAdapter adapter)
        {
