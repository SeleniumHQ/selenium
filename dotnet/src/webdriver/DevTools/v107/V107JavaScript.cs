// <copyright file="V107JavaScript.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Class containing the JavaScript implementation for version 107 of the DevTools Protocol.
    /// </summary>
    public class V107JavaScript : JavaScript
    {
        private RuntimeAdapter runtime;
        private PageAdapter page;

        /// <summary>
        /// Initializes a new instance of the <see cref="V107JavaScript"/> class.
        /// </summary>
        /// <param name="runtime">The DevTools Protocol adapter for the Runtime domain.</param>
        /// <param name="page">The DevTools Protocol adapter for the Page domain.</param>
        public V107JavaScript(RuntimeAdapter runtime, PageAdapter page)
        {
