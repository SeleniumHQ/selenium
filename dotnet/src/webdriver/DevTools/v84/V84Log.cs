// <copyright file="V84Log.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Class containing the browser's log as referenced by version 84 of the DevTools Protocol.
    /// </summary>
    public class V84Log : DevTools.Log
    {
        LogAdapter adapter;

        /// <summary>
        /// Initializes a new instance of the <see cref="V84Log"/> class.
        /// </summary>
