// <copyright file="V84JavaScript.cs" company="WebDriver Committers">
...
using OpenQA.Selenium.DevTools.V84.Page;
using OpenQA.Selenium.DevTools.V84.Runtime;
...
namespace OpenQA.Selenium.DevTools.V84
{
    ...
    public class V84JavaScript : IJavaScript
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V84JavaScript"/> class.
        /// </summary>
        /// <param name="runtime">The DevTools Protocol adapter for the Runtime domain.</param>
        /// <param name="page">The DevTools Protocol adapter for the Page domain.</param>
        public V84JavaScript(RuntimeAdapter runtime, PageAdapter page)
        {
