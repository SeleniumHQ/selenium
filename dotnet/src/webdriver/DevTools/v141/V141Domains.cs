// <copyright file="V141Domains.cs" company="Selenium Committers">
...
public class V141Domains : DevToolsDomains
{
    ...
    public V141Domains(DevToolsSession session)
    {
    ...
    /// </summary>
    public static int DevToolsVersion => 141;
    ...
    /// </summary>
    public override DevTools.Network Network => new V141Network(domains.Network, domains.Fetch);

    /// <summary>
    /// Gets the object used for manipulating the browser's JavaScript execution.
    /// </summary>
    public override JavaScript JavaScript => new V141JavaScript(domains.Runtime, domains.Page);

    /// <summary>
    /// Gets the object used for manipulating DevTools Protocol targets.
    /// </summary>
    public override DevTools.Target Target => new V141Target(domains.Target);

    /// <summary>
    /// Gets the object used for manipulating the browser's logs.
    /// </summary>
    public override DevTools.Log Log => new V141Log(domains.Log);
}
