...
public abstract class JavaScript
{
    ...
    public abstract Task<string> AddScriptToEvaluateOnNewDocument([StringSyntax("javascript")] string script);
    ...
    /// </remarks>
    internal abstract Task Evaluate([StringSyntax("javascript")] string script);
