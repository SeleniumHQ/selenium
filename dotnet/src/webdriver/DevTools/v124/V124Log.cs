// <copyright file="V124Log.cs" company="WebDriver Committers">
...
{
    /// <summary>
    /// Class containing the browser's log as referenced by version 124 of the DevTools Protocol.
    /// </summary>
    public class V124Log : DevTools.Log
    {
        private LogAdapter adapter;

        /// <summary>
        /// Initializes a new instance of the <see cref="V124Log"/> class.
        /// </summary>
