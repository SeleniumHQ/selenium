// <copyright file="DevToolsSessionLogMessageEventArgs.cs" company="Selenium Committers">
...
public class DevToolsSessionLogMessageEventArgs(DevToolsSessionLogLevel level, string message, params object?[] args) : EventArgs
{

    /// <summary>
    /// Gets the message content.
    /// </summary>
    public string Message { get; } = string.Format(message, args);

    /// <summary>
    /// Gets the message log level.
    /// </summary>
    public DevToolsSessionLogLevel Level { get; } = level;
}
