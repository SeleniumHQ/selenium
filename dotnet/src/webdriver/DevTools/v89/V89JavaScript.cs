// <copyright file="V89JavaScript.cs" company="WebDriver Committers">
...
using OpenQA.Selenium.DevTools.V89.Page;
using OpenQA.Selenium.DevTools.V89.Runtime;
...
namespace OpenQA.Selenium.DevTools.V89
{
    ...
    public class V89JavaScript : JavaScript
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V89JavaScript"/> class.
        /// </summary>
        /// <param name="runtime">The DevTools Protocol adapter for the Runtime domain.</param>
        /// <param name="page">The DevTools Protocol adapter for the Page domain.</param>
        public V89JavaScript(RuntimeAdapter runtime, PageAdapter page)
        {
