// <copyright file="V144Target.cs" company="Selenium Committers">
...
using OpenQA.Selenium.DevTools.V144.Target;

namespace OpenQA.Selenium.DevTools.V144;

/// <summary>
/// Class providing functionality for manipulating targets for version 144 of the DevTools Protocol
/// </summary>
public class V144Target : DevTools.Target
{
    private readonly TargetAdapter adapter;

    /// <summary>
    /// Initializes a new instance of the <see cref="V144Target"/> class.
    /// </summary>
    ...
    public V144Target(TargetAdapter adapter)
    {
