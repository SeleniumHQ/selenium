// <copyright file="V142JavaScript.cs" company="Selenium Committers">
...
/// <summary>
/// Class containing the JavaScript implementation for version 142 of the DevTools Protocol.
/// </summary>
public class V142JavaScript : JavaScript
{
    private readonly RuntimeAdapter runtime;
    private readonly PageAdapter page;

    /// <summary>
    /// Initializes a new instance of the <see cref="V142JavaScript"/> class.
    /// </summary>
    ...
    public V142JavaScript(RuntimeAdapter runtime, PageAdapter page)
    {
