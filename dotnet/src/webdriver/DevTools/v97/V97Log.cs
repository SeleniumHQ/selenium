// <copyright file="V97Log.cs" company="WebDriver Committers">
...
using OpenQA.Selenium.DevTools.V97.Log;
...
namespace OpenQA.Selenium.DevTools.V97
{
    ...
    /// </summary>
    public class V97Log : DevTools.Log
    {
        private LogAdapter adapter;

        /// <summary>
        /// Initializes a new instance of the <see cref="V97Log"/> class.
        /// </summary>
        /// <param name="adapter">The adapter for the Log domain.</param>
        public V97Log(LogAdapter adapter)
        {
