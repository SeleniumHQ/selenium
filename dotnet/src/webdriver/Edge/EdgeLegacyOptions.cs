// <copyright file="EdgeLegacyOptions.cs" company="Microsoft">
...
namespace OpenQA.Selenium.Edge
{
    ...
    /// used with Edge Legacy.
    /// </summary>
    /// <example>
    /// <code>
    /// EdgeLegacyOptions options = new EdgeLegacyOptions();
    /// </code>
    /// <para></para>
    ...
    /// </code>
    /// </example>
    public class EdgeLegacyOptions : DriverOptions
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeLegacyOptions"/> class.
        /// </summary>
        public EdgeLegacyOptions()
        {
        ...
        /// <summary>
        /// Returns DesiredCapabilities for Edge Legacy with these options included as
        /// capabilities. This copies the options. Further changes will not be
        /// reflected in the returned capabilities.
        /// </summary>
        /// <returns>The DesiredCapabilities for Edge Legacy with these options.</returns>
