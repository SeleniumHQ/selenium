...
public sealed partial class NetworkModule : Module
{
    ...
    public async Task<Collector> AddDataCollectorAsync(IEnumerable<DataType> DataTypes, int MaxEncodedDataSize, AddDataCollectorOptions? options = null)
    {
        ...
        var result = await Broker.ExecuteCommandAsync<AddDataCollectorCommand, AddDataCollectorResult>(new AddDataCollectorCommand(@params), options, _jsonContext).ConfigureAwait(false);
    ...
    public async Task<Intercept> AddInterceptAsync(IEnumerable<InterceptPhase> phases, AddInterceptOptions? options = null)
    {
        ...
        var result = await Broker.ExecuteCommandAsync<AddInterceptCommand, AddInterceptResult>(new AddInterceptCommand(@params), options, _jsonContext).ConfigureAwait(false);
    ...
    public async Task<EmptyResult> RemoveDataCollectorAsync(Collector collector, RemoveDataCollectorOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<RemoveDataCollectorCommand, EmptyResult>(new RemoveDataCollectorCommand(@params), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> RemoveInterceptAsync(Intercept intercept, RemoveInterceptOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<RemoveInterceptCommand, EmptyResult>(new RemoveInterceptCommand(@params), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> SetCacheBehaviorAsync(CacheBehavior behavior, SetCacheBehaviorOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<SetCacheBehaviorCommand, EmptyResult>(new SetCacheBehaviorCommand(@params), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> SetExtraHeadersAsync(IEnumerable<Header> headers, SetExtraHeadersOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<SetExtraHeadersCommand, EmptyResult>(new SetExtraHeadersCommand(@params), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> ContinueRequestAsync(Request request, ContinueRequestOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<ContinueRequestCommand, EmptyResult>(new ContinueRequestCommand(@params), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> ContinueResponseAsync(Request request, ContinueResponseOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<ContinueResponseCommand, EmptyResult>(new ContinueResponseCommand(@params), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> FailRequestAsync(Request request, FailRequestOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<FailRequestCommand, EmptyResult>(new FailRequestCommand(@params), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    public async Task<BytesValue> GetDataAsync(DataType dataType, Request request, GetDataOptions? options = null)
    {
        ...
        var result = await Broker.ExecuteCommandAsync<GetDataCommand, GetDataResult>(new GetDataCommand(@params), options, _jsonContext).ConfigureAwait(false);
    ...
    public async Task<EmptyResult> ProvideResponseAsync(Request request, ProvideResponseOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<ProvideResponseCommand, EmptyResult>(new ProvideResponseCommand(@params), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.ExecuteCommandAsync<ContinueWithAuthCommand, EmptyResult>(new ContinueWithAuthCommand(new ContinueWithAuthCredentials(request, credentials)), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.ExecuteCommandAsync<ContinueWithAuthCommand, EmptyResult>(new ContinueWithAuthCommand(new ContinueWithAuthDefaultCredentials(request)), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.ExecuteCommandAsync<ContinueWithAuthCommand, EmptyResult>(new ContinueWithAuthCommand(new ContinueWithAuthCancelCredentials(request)), options, _jsonContext).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("network.beforeRequestSent", handler, options, _jsonContext).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("network.responseStarted", handler, options, _jsonContext).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("network.responseCompleted", handler, options, _jsonContext).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("network.fetchError", handler, options, _jsonContext).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("network.authRequired", handler, options, _jsonContext).ConfigureAwait(false);
    }
