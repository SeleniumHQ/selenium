...
{
    private BiDiJsonSerializerContext _context;
    public async Task<BrowsingContext> CreateAsync(ContextType type, CreateOptions? options = null)
    {
        ...
        var createResult = await Broker.ExecuteCommandAsync<CreateCommand, CreateResult>(new CreateCommand(@params), options, _context).ConfigureAwait(false);
    ...
    public async Task<NavigateResult> NavigateAsync(BrowsingContext context, string url, NavigateOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<NavigateCommand, NavigateResult>(new NavigateCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> ActivateAsync(BrowsingContext context, ActivateOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<ActivateCommand, EmptyResult>(new ActivateCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<LocateNodesResult> LocateNodesAsync(BrowsingContext context, Locator locator, LocateNodesOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<LocateNodesCommand, LocateNodesResult>(new LocateNodesCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<CaptureScreenshotResult> CaptureScreenshotAsync(BrowsingContext context, CaptureScreenshotOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<CaptureScreenshotCommand, CaptureScreenshotResult>(new CaptureScreenshotCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> CloseAsync(BrowsingContext context, CloseOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<CloseCommand, EmptyResult>(new CloseCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<TraverseHistoryResult> TraverseHistoryAsync(BrowsingContext context, int delta, TraverseHistoryOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<TraverseHistoryCommand, TraverseHistoryResult>(new TraverseHistoryCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<NavigateResult> ReloadAsync(BrowsingContext context, ReloadOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<ReloadCommand, NavigateResult>(new ReloadCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> SetViewportAsync(BrowsingContext context, SetViewportOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<SetViewportCommand, EmptyResult>(new SetViewportCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<GetTreeResult> GetTreeAsync(GetTreeOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<GetTreeCommand, GetTreeResult>(new GetTreeCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<PrintResult> PrintAsync(BrowsingContext context, PrintOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<PrintCommand, PrintResult>(new PrintCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<EmptyResult> HandleUserPromptAsync(BrowsingContext context, HandleUserPromptOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<HandleUserPromptCommand, EmptyResult>(new HandleUserPromptCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.navigationStarted", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.fragmentNavigated", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.historyUpdated", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.domContentLoaded", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.load", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.downloadWillBegin", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.downloadEnd", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.navigationAborted", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.navigationFailed", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.navigationCommitted", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.contextCreated", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.contextDestroyed", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.userPromptOpened", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("browsingContext.userPromptClosed", handler, options, _context).ConfigureAwait(false);
    }
