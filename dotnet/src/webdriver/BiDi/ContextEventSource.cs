...
public sealed class ContextEventSource<TEventArgs> where TEventArgs : EventArgs
{
    ...
    public Task<ISubscription> OnAsync(Action<TEventArgs> handler, ContextSubscriptionOptions? options = null, CancellationToken cancellationToken = default)
    {
    ...
    public Task<ISubscription> OnAsync(Func<TEventArgs, Task> handler, ContextSubscriptionOptions? options = null, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(handler);
