...
internal sealed class EventDispatcher : IAsyncDisposable
{
    ...
    public async Task<IEventListener> SubscribeAsync<TEventArgs>(
        ...
        where TEventArgs : EventArgs
    {
        ...
        subscription = new EventListener<TEventArgs>(
