...
public sealed class ScriptModule : Module
{
    ...
    public async Task<EvaluateResult> EvaluateAsync(string expression, bool awaitPromise, Target target, EvaluateOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<EvaluateCommand, EvaluateResult>(new EvaluateCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<EvaluateResult> CallFunctionAsync(string functionDeclaration, bool awaitPromise, Target target, CallFunctionOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<CallFunctionCommand, EvaluateResult>(new CallFunctionCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<GetRealmsResult> GetRealmsAsync(GetRealmsOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<GetRealmsCommand, GetRealmsResult>(new GetRealmsCommand(@params), options, _context).ConfigureAwait(false);
    }
    ...
    public async Task<PreloadScript> AddPreloadScriptAsync(string functionDeclaration, AddPreloadScriptOptions? options = null)
    {
        ...
        var result = await Broker.ExecuteCommandAsync<AddPreloadScriptCommand, AddPreloadScriptResult>(new AddPreloadScriptCommand(@params), options, _context).ConfigureAwait(false);
    ...
    public async Task<EmptyResult> RemovePreloadScriptAsync(PreloadScript script, RemovePreloadScriptOptions? options = null)
    {
        ...
        return await Broker.ExecuteCommandAsync<RemovePreloadScriptCommand, EmptyResult>(new RemovePreloadScriptCommand(@params), options, _context).ConfigureAwait(false);
    }

    public async Task<Subscription> OnMessageAsync(Func<MessageEventArgs, Task> handler, SubscriptionOptions? options = null)
    {
        return await Broker.SubscribeAsync("script.message", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("script.realmCreated", handler, options, _context).ConfigureAwait(false);
    }
    ...
    {
        return await Broker.SubscribeAsync("script.realmDestroyed", handler, options, _context).ConfigureAwait(false);
    }
