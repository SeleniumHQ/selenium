...
namespace OpenQA.Selenium
{
    ...
    public class AlertsTest : DriverTestFixture
    {
        ...
        [IgnoreBrowser(Browser.MSEdge, "This is the correct behavior, for the SwitchTo call to throw if it happens before the setTimeout call occurs in the browser and the alert is displayed.")]
        ...
        [IgnoreBrowser(Browser.MSEdge, "Test with onLoad alert hangs Chrome.")]
        ...
        [IgnoreBrowser(Browser.MSEdge, "MSEdge does not trigger alerts on unload.")]
        ...
        [IgnoreBrowser(Browser.MSEdge, "MSEdge does not implicitly handle onBeforeUnload alert")]
        ...
        [IgnoreBrowser(Browser.MSEdge, "Test as written does not trigger alert")]
        [IgnoreBrowser(Browser.Firefox, "After version 27, Firefox does not trigger alerts on unload.")]
        [IgnoreBrowser(Browser.Edge, "Edge does not trigger alerts on unload.")]
