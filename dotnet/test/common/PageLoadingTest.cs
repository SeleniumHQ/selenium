...
namespace OpenQA.Selenium
{
    ...
    public class PageLoadingTest : DriverTestFixture
    {
        ...
        [IgnoreBrowser(Browser.MSEdge, "Microsoft WebDriver does not support eager page load strategy")]
        ...
        [IgnoreBrowser(Browser.MSEdge, "Microsoft WebDriver does, in fact, stop loading page after a timeout.")]
        [IgnoreBrowser(Browser.Opera, "Not implemented for browser")]
