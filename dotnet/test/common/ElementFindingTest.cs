...
namespace OpenQA.Selenium
{
    ...
    public class ElementFindingTest : DriverTestFixture
    {
        ...
        [IgnoreBrowser(Browser.ChromiumEdge, "Class name is perfectly legal when using CSS selector, if properly escaped.")]
        [IgnoreBrowser(Browser.Opera, "Throws WebDriverException")]
        ...
        [IgnoreBrowser(Browser.ChromiumEdge, "Driver does not support finding elements on XML documents.")]
