...
namespace OpenQA.Selenium.Interactions
{
    ...
    public class BasicMouseInterfaceTest : DriverTestFixture
    {
        ...
        [IgnoreBrowser(Browser.ChromiumEdge, "Drivers correctly click at current mouse position without another move, preserving mouse position.")]
        ...
        [IgnoreBrowser(Browser.ChromiumEdge, "Moving outside of view port throws exception in spec-compliant driver")]
