...
namespace OpenQA.Selenium.DevTools
{
    ...
    public class DevToolsProfilerTest : DevToolsTestFixture
    {
        ...
        public async Task SampleGetBestEffortProfilerTest()
        {
            ...
            await domains.Profiler.SetSamplingInterval(new V112.Profiler.SetSamplingIntervalCommandSettings()
            {
                Interval = 30
            });
        ...
        public async Task SampleSetStartPreciseCoverageTest()
        {
            ...
            await domains.Profiler.Enable();
            driver.Url = simpleTestPage;
            await domains.Profiler.StartPreciseCoverage(new V112.Profiler.StartPreciseCoverageCommandSettings()
            {
                CallCount = true,
                Detailed = true
            });
        ...
        public async Task SampleProfileEvents()
        {
            ...
            EventHandler<V112.Profiler.ConsoleProfileStartedEventArgs> consoleProfileStartedHandler = (sender, e) =>
            {
            ...
            EventHandler<V112.Profiler.ConsoleProfileFinishedEventArgs> consoleProfileFinishedHandler = (sender, e) =>
            {
                Assert.That(e, Is.Not.Null);
                finishSync.Set();
            };
        ...
        private void ValidateProfile(V112.Profiler.Profile profiler)
        {
