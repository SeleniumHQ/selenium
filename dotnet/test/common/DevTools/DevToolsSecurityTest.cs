...
namespace OpenQA.Selenium.DevTools
{
    ...
    public class DevToolsSecurityTest : DevToolsTestFixture
    {
        ...
        public async Task LoadInsecureWebsite()
        {
            ...
            await domains.Security.SetIgnoreCertificateErrors(new V112.Security.SetIgnoreCertificateErrorsCommandSettings()
            {
                Ignore = false
            });
            ...
            EventHandler<V112.Security.SecurityStateChangedEventArgs> securityStateChangedHandler = (sender, e) =>
            {
                summary = e.Summary;
                sync.Set();
            };
