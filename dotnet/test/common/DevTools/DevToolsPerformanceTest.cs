...
namespace OpenQA.Selenium.DevTools
{
    ...
    public class DevToolsPerformanceTest : DevToolsTestFixture
    {
        ...
        public async Task EnableAndDisablePerformance()
        {
            ...
            await domains.Performance.Enable(new V106.Performance.EnableCommandSettings());
        ...
        public async Task SetTimeDomainTimeTickPerformance()
        {
            var domains = session.GetVersionSpecificDomains<V106.DevToolsSessionDomains>();
            await domains.Performance.Disable();
            await domains.Performance.SetTimeDomain(new V106.Performance.SetTimeDomainCommandSettings()
            {
