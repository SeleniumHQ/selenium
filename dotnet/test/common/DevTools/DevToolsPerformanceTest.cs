...
namespace OpenQA.Selenium.DevTools
{
    ...
    public class DevToolsPerformanceTest : DevToolsTestFixture
    {
        ...
        public async Task EnableAndDisablePerformance()
        {
            ...
            await domains.Performance.Enable(new V105.Performance.EnableCommandSettings());
        ...
        public async Task SetTimeDomainTimeTickPerformance()
        {
            var domains = session.GetVersionSpecificDomains<V105.DevToolsSessionDomains>();
            await domains.Performance.Disable();
            await domains.Performance.SetTimeDomain(new V105.Performance.SetTimeDomainCommandSettings()
            {
