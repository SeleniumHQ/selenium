// <copyright file="DevToolsNetworkTests.cs" company="Selenium Committers">
...
[TestFixture]
public class DevToolsNetworkTests : DevToolsTestFixture
{
    [Test]
    ...
    public void GetSetDeleteAndClearAllCookies()
    {
        ...
        //Cookie cookie = new ReturnedCookie("name", "value", Urls.HostName, "/devtools/test", null, false, true);
