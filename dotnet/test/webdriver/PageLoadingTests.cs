// <copyright file="PageLoadingTests.cs" company="Selenium Committers">
...
public class PageLoadingTests : DriverTestFixture
{
    ...
    public void NoneStrategyShouldNotWaitForPageToLoad()
    {
        ...
        string slowPage = Urls.WhereIs("sleep?time=5");
    ...
    public void EagerStrategyShouldNotWaitForResources()
    {
        ...
        string slowPage = Urls.WhereIs("slowLoadingResourcePage.html");
    ...
    public void EagerStrategyShouldWaitForDocumentToBeLoaded()
    {
        ...
        string slowPage = Urls.WhereIs("sleep?time=3");
