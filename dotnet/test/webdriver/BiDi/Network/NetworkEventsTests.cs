...
internal class NetworkEventsTests : BiDiTestFixture
{
    ...
    public async Task CanListenToBeforeRequestSentEvent()
    {
        ...
        await using var subscription = await context.Network.BeforeRequestSent.OnAsync(tcs.SetResult);
    ...
    public async Task CanListenToResponseStartedEvent()
    {
        ...
        await using var subscription = await context.Network.ResponseStarted.OnAsync(tcs.SetResult);
    ...
    public async Task CanListenToResponseCompletedEvent()
    {
        ...
        await using var subscription = await context.Network.ResponseCompleted.OnAsync(tcs.SetResult);
    ...
    public async Task CanListenToBeforeRequestSentEventWithCookie()
    {
        ...
        await using var subscription = await bidi.Network.BeforeRequestSent.OnAsync(tcs.SetResult);
    ...
    public async Task CanListenToOnAuthRequiredEvent()
    {
        ...
        await using var subscription = await context.Network.AuthRequired.OnAsync(tcs.SetResult);
    ...
    public async Task CanListenToFetchError()
    {
        ...
        await using var subscription = await context.Network.FetchError.OnAsync(tcs.SetResult);
