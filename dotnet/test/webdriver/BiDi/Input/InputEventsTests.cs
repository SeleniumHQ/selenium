// <copyright file="InputEventsTests.cs" company="Selenium Committers">
...
internal class InputEventsTests : BiDiTestFixture
{
    ...
    public async Task CanListenToFileDialogOpenedEvent()
    {
        ...
        await using var subscription = await context.Input.FileDialogOpenedEvent.OnAsync(e => tcs.TrySetResult(e));
