// <copyright file="ScriptEventsTests.cs" company="Selenium Committers">
...
internal class ScriptEventsTests : BiDiTestFixture
{
    ...
    public async Task CanListenToChannelMessage()
    {
        ...
        await bidi.Script.MessageEvent.OnAsync(tcs.SetResult);
    ...
    public async Task CanListenToRealmCreatedEvent()
    {
        ...
        await bidi.Script.RealmCreatedEvent.OnAsync(tcs.SetResult);
    ...
    public async Task CanListenToRealmDestroyedEvent()
    {
        ...
        await bidi.Script.RealmDestroyedEvent.OnAsync(tcs.SetResult);
