...
/**
 * Injects an asynchronous script into the current page for execution.
 * The script should signla that it is finished by invoking the callback
 * function, which will always be the last argument passed to the injected
 * script.
 */
class AsyncScriptExecutor {
   ...
   *
   * <p/>This class has public visibility so it can be correctly wrapped in a
  ...
  public static class AsyncScriptResult {
    ...
    /**
     * Waits for the script to signal it is done by calling
     * {@link #callback(Object) callback}.
     *
     * @return The script result.
     ...
     *
     * <p/>This method has public visibility for Rhino and should never be
     * called by code outside of Rhino.
     *
    ...
    /**
     * Function exposed in JavaScript to signal a timeout. Has no effect if
     * called after the {@link #callback(Object) callback} function.
     *
     * <p/>This method has public visibility for Rhino and should never be
     * called by code outside of Rhino.
     */
    ...
    /**
     * Function exposed to JavaScript to signal that a page unload event was
     * fired. WebDriver's asynchronous script execution model does not permit
     * new page loads.
     *
     * <p/>This method has public visibility for Rhino and should never be
     * called by code outside of Rhino.
