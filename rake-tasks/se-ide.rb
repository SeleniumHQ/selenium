...
namespace :se_ide do
  ...
  task :setup_proxy do
    if unix?
      ...
      ln_s "build/common/src/js/selenium/core.js.js", "ide/main/src/content/selenium/scripts/atoms.js"
      ...
      # atoms
      f = Dir.glob(base_ide_dir + "/build/common/src/js/selenium/core.js.js")
      f.each do |c|
        files << base_ide_dir + "/build/common/src/js/selenium/core.js.js"
