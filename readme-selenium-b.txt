Selenium B currently consists of and XML-RPC binding between the browser
...
This will Run the Java Selenium B unit-and integration tests.
The integration test will launch a browser that loads a JsUnit
test suite, which will run the SelB browser part of the unit tests
