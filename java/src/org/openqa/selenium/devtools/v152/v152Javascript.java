...
import org.openqa.selenium.devtools.v152.runtime.model.BindingCalled;

public class v152Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v152Javascript(DevTools devtools) {
    super(devtools);
  }
