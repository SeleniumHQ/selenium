...
public class v142Events extends Events<ConsoleAPICalled, ExceptionThrown> {

  public v142Events(DevTools devtools) {
    super(devtools);
  }
  ...
  protected JavascriptException toJsException(ExceptionThrown event) {
    ...
    Optional<org.openqa.selenium.devtools.v142.runtime.model.RemoteObject> maybeException =
