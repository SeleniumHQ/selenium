...
import org.openqa.selenium.devtools.v148.runtime.model.BindingCalled;

public class v148Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v148Javascript(DevTools devtools) {
    super(devtools);
  }
