...
import org.openqa.selenium.devtools.v124.runtime.model.BindingCalled;

public class v124Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v124Javascript(DevTools devtools) {
    super(devtools);
  }
