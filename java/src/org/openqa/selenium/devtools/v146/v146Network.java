...
import org.openqa.selenium.devtools.v146.fetch.model.AuthChallengeResponse;
import org.openqa.selenium.devtools.v146.fetch.model.AuthRequired;
...
import org.openqa.selenium.devtools.v146.fetch.model.RequestPaused;
...
public class v146Network extends Network<AuthRequired, RequestPaused> {

  private static final Logger LOG = Logger.getLogger(v146Network.class.getName());

  public v146Network(DevTools devTools) {
    super(devTools);
  }

  @Override
  protected Command<Void> setUserAgentOverride(UserAgent userAgent) {
    return org.openqa.selenium.devtools.v146.network.Network.setUserAgentOverride(
        userAgent.userAgent(), userAgent.acceptLanguage(), userAgent.platform(), Optional.empty());
  }

  @Override
  protected Command<Void> enableNetworkCaching() {
    return org.openqa.selenium.devtools.v146.network.Network.setCacheDisabled(false);
  }

  @Override
  protected Command<Void> disableNetworkCaching() {
    return org.openqa.selenium.devtools.v146.network.Network.setCacheDisabled(true);
  }
