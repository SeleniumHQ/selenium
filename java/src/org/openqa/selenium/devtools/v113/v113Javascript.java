...
import org.openqa.selenium.devtools.v113.runtime.model.BindingCalled;

public class v113Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v113Javascript(DevTools devtools) {
    super(devtools);
  }
