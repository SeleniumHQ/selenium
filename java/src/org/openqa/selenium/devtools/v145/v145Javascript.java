...
import org.openqa.selenium.devtools.v145.runtime.model.BindingCalled;

public class v145Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v145Javascript(DevTools devtools) {
    super(devtools);
  }
