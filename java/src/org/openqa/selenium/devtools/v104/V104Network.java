...
import org.openqa.selenium.devtools.v104.fetch.model.AuthRequired;
...
public class V104Network extends Network<AuthRequired, RequestPaused> {
  ...
  private static final Logger LOG = Logger.getLogger(V104Network.class.getName());

  public V104Network(DevTools devTools) {
    super(devTools);
  }

  @Override
  protected Command<Void> setUserAgentOverride(UserAgent userAgent) {
    return org.openqa.selenium.devtools.v104.network.Network.setUserAgentOverride(
      userAgent.userAgent(), userAgent.acceptLanguage(), userAgent.platform(), Optional.empty());
  }

  @Override
  protected Command<Void> enableNetworkCaching() {
    return org.openqa.selenium.devtools.v104.network.Network.setCacheDisabled(false);
  }

  @Override
  protected Command<Void> disableNetworkCaching() {
    return org.openqa.selenium.devtools.v104.network.Network.setCacheDisabled(true);
  }
