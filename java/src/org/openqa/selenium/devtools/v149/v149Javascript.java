...
import org.openqa.selenium.devtools.v149.runtime.model.BindingCalled;

public class v149Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v149Javascript(DevTools devtools) {
    super(devtools);
  }
