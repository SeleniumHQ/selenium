...
import org.openqa.selenium.devtools.v141.runtime.model.BindingCalled;

public class v141Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v141Javascript(DevTools devtools) {
    super(devtools);
  }
