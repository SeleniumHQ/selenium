...
import org.openqa.selenium.devtools.v120.runtime.model.BindingCalled;

public class v120Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v120Javascript(DevTools devtools) {
    super(devtools);
  }
