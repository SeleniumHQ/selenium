...
public class v122Events extends Events<ConsoleAPICalled, ExceptionThrown> {

  public v122Events(DevTools devtools) {
    super(devtools);
  }
  ...
  protected JavascriptException toJsException(ExceptionThrown event) {
    ...
    Optional<org.openqa.selenium.devtools.v122.runtime.model.RemoteObject> maybeException =
