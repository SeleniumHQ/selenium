...
import org.openqa.selenium.devtools.v150.runtime.model.BindingCalled;

public class v150Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v150Javascript(DevTools devtools) {
    super(devtools);
  }
