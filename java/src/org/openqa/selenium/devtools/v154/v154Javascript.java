...
import org.openqa.selenium.devtools.v154.runtime.model.BindingCalled;

public class v154Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v154Javascript(DevTools devtools) {
    super(devtools);
  }
