...
import org.openqa.selenium.devtools.v153.runtime.model.BindingCalled;

public class v153Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v153Javascript(DevTools devtools) {
    super(devtools);
  }
