...
import org.openqa.selenium.devtools.v127.fetch.model.*;
import org.openqa.selenium.devtools.v127.network.model.Request;
import org.openqa.selenium.internal.Either;
import org.openqa.selenium.remote.http.HttpRequest;
import org.openqa.selenium.remote.http.HttpResponse;

public class v127Network extends Network<AuthRequired, RequestPaused> {

  private static final Logger LOG = Logger.getLogger(v127Network.class.getName());

  public v127Network(DevTools devTools) {
    super(devTools);
  }
  ...
  protected Command<Void> enableNetworkCaching() {
    return org.openqa.selenium.devtools.v127.network.Network.setCacheDisabled(false);
  }

  @Override
  protected Command<Void> disableNetworkCaching() {
    return org.openqa.selenium.devtools.v127.network.Network.setCacheDisabled(true);
  }
