...
import org.openqa.selenium.devtools.v127.runtime.model.BindingCalled;

public class v127Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v127Javascript(DevTools devtools) {
    super(devtools);
  }
