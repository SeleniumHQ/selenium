...
import org.openqa.selenium.devtools.v143.fetch.model.AuthRequired;
...
public class v143Network extends Network<AuthRequired, RequestPaused> {

  private static final Logger LOG = Logger.getLogger(v143Network.class.getName());

  public v143Network(DevTools devTools) {
    super(devTools);
  }
