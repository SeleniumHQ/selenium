...
public class v143Events extends Events<ConsoleAPICalled, ExceptionThrown> {

  public v143Events(DevTools devtools) {
    super(devtools);
  }
  ...
  protected JavascriptException toJsException(ExceptionThrown event) {
    ...
    Optional<org.openqa.selenium.devtools.v143.runtime.model.RemoteObject> maybeException =
