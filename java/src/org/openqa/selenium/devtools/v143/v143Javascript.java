...
import org.openqa.selenium.devtools.v143.runtime.model.BindingCalled;

public class v143Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v143Javascript(DevTools devtools) {
    super(devtools);
  }
