...
import org.openqa.selenium.devtools.v144.runtime.model.BindingCalled;

public class v144Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v144Javascript(DevTools devtools) {
    super(devtools);
  }
