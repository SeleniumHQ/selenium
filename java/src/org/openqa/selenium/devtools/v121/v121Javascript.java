...
import org.openqa.selenium.devtools.v121.runtime.model.BindingCalled;

public class v121Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v121Javascript(DevTools devtools) {
    super(devtools);
  }
