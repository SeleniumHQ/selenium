...
import org.openqa.selenium.devtools.v123.runtime.model.BindingCalled;

public class v123Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v123Javascript(DevTools devtools) {
    super(devtools);
  }
