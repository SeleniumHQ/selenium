...
public interface ActiveSession extends HttpHandler {
   ...
   * Node process (for example, a Docker container, a Kubernetes Pod, or a relayed remote endpoint)
   * and therefore does not share the Node's local filesystem. When {@code true}, file upload and
