...
public class NodeFlags implements HasRoles {
  ...
  @Parameter(
      ...
      description =
          "Let X be the session-timeout in seconds. The Node will automatically kill "
  ...
  @Parameter(
      ...
      arity = 1,
      description =
          "Autodetect which drivers are available on the current system, "
  ...
  @Parameter(
      ...
      description =
          "Drivers that should be checked. If specified, will skip autoconfiguration. "
  ...
  @Parameter(
      ...
      description =
          "Mapping of fully qualified class name to a browser configuration that this "
              + "matches against. "
  ...
  @Parameter(
      names = {"--hub"},
      description =
          "The address of the Hub in a Hub-and-Node configuration. This can "
  ...
  @Parameter(
      ...
      description =
          "How often, in seconds, the Node will try to register itself for "
  ...
  @Parameter(
      ...
      description =
          "How long, in seconds, will the Node try to register to the Distributor for "
  ...
  @Parameter(
      ...
      description =
          "Drain and shutdown the Node after X sessions have been executed. Useful for "
  ...
  @Parameter(
      ...
      arity = 1,
      description =
          "Enable CDP proxying in Grid. A Grid admin can disable CDP if the network does "
  ...
  @Parameter(
      ...
      arity = 1,
      description =
          "Enable BiDi proxying in Grid. A Grid admin can disable BiDi if the network does "
              + "not allow websockets. True by default")
  ...
  @Parameter(
      ...
      description =
          "Full classname of non-default Node implementation. This is used to manage "
