...
public class StorageKeyPartitionDescriptor extends PartitionDescriptor {
  ...
  public StorageKeyPartitionDescriptor userContext(String userContext) {
    map.put("userContext", userContext);
    return this;
  }

  public StorageKeyPartitionDescriptor sourceOrigin(String sourceOrigin) {
    map.put("sourceOrigin", sourceOrigin);
    return this;
  }
