...
public abstract class AddHasCasting
  ...
  protected static final String GET_CAST_SINKS = "getCastSinks";
  protected static final String SET_CAST_SINK_TO_USE = "selectCastSink";
  protected static final String START_CAST_TAB_MIRRORING = "startCastTabMirroring";
  protected static final String START_CAST_DESKTOP_MIRRORING = "startDesktopMirroring";
  protected static final String GET_CAST_ISSUE_MESSAGE = "getCastIssueMessage";
  protected static final String STOP_CASTING = "stopCasting";
  ...
  public HasCasting getImplementation(Capabilities capabilities, ExecuteMethod executeMethod) {
    return new HasCasting() {
      ...
      public void startDesktopMirroring(String deviceName) {
        ...
        executeMethod.execute(START_CAST_DESKTOP_MIRRORING,
                              Map.of("sinkName", deviceName));
      }
