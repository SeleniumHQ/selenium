...
public class AddHasNetworkConditions
  ...
  @Override
  public HasNetworkConditions getImplementation(Capabilities capabilities,
    ...
    return new HasNetworkConditions() {
      ...
      public ChromiumNetworkConditions getNetworkConditions() {
        ...
        networkConditions.setDownloadThroughput(
          ((Number) result.getOrDefault(ChromiumNetworkConditions.DOWNLOAD_THROUGHPUT,
                                        -1)).intValue());
        networkConditions.setDownloadThroughput(
          ((Number) result.getOrDefault(ChromiumNetworkConditions.UPLOAD_THROUGHPUT,
                                        -1)).intValue());
      ...
      public void setNetworkConditions(ChromiumNetworkConditions networkConditions) {
        ...
        Map<String, Object>
          conditions =
         Map.of(ChromiumNetworkConditions.OFFLINE, networkConditions.getOffline(),
        ...
        executeMethod.execute(SET_NETWORK_CONDITIONS,
                             Map.of("network_conditions", conditions));
      }
