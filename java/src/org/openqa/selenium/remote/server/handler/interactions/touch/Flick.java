    ...
    if (allParameters.containsKey(ELEMENT) && allParameters.get(ELEMENT) != null) {
      ...
      try {
        ...
        throw new WebDriverException(
          "Illegal (non-numeric) x offset value for flick passed: " + allParameters.get(XOFFSET),
          ex);
      }
      try {
        ...
        throw new WebDriverException(
          "Illegal (non-numeric) y offset value for flick passed: " + allParameters.get(YOFFSET),
          ex);
      }
      try {
        ...
        throw new WebDriverException(
          "Illegal (non-numeric) speed value for flick passed: " + allParameters.get(SPEED), ex);
      }
      ...
      try {
        ...
        throw new WebDriverException(
          "Illegal (non-numeric) x speed value for flick passed: " + allParameters.get(XSPEED), ex);
      }
      try {
        ySpeed = ((Number) allParameters.get(YSPEED)).intValue();
      } catch (ClassCastException ex) {
        throw new WebDriverException(
          "Illegal (non-numeric) y speed value for flick passed: " + allParameters.get(YSPEED), ex);
      }
    }
  }
