...
public class ActiveSessionFactory implements SessionFactory {
  ...
  public ActiveSessionFactory(Tracer tracer) {
    ...
    ImmutableMap.<Predicate<Capabilities>, String>builder()
      ...
      .put(containsKey(Pattern.compile("^moz:.*")),
      ...
      .put(containsKey(Pattern.compile("^safari\\..*")),
    ...
    bind(builder, "org.openqa.selenium.htmlunit.HtmlUnitDriver",
         browserName(HTMLUNIT.browserName()),
  ...
  @VisibleForTesting
  private Iterable<DriverProvider> loadDriverProviders() {
