...
class ScriptManagerTest {
  ...
  void canCallFunctionWithArguments() {
    ...
    ArgumentValue value1 = new ArgumentValue(LocalValue.createStringValue("ARGUMENT_STRING_VALUE"));
  ...
  void canEvaluateScript() {
    ...
    EvaluateResult result =
        manager.evaluateFunctionInBrowsingContext(id, "1 + 2", true, Optional.empty());
  ...
  void canEvaluateScriptThatThrowsException() {
    ...
    EvaluateResult result =
        manager.evaluateFunctionInBrowsingContext(
  ...
  void canEvaluateInASandBox() {
    ...
    // Make changes without sandbox
    manager.evaluateFunctionInBrowsingContext(id, "window.foo = 1", true, Optional.empty());
  ...
  void canEvaluateInARealm() {
    ...
    manager.evaluateFunctionInRealm(firstTabRealmId, "window.foo = 3", true, Optional.empty());

    manager.evaluateFunctionInRealm(secondTabRealmId, "window.foo = 5", true, Optional.empty());

    EvaluateResult firstContextResult =
        manager.evaluateFunctionInRealm(firstTabRealmId, "window.foo", true, Optional.empty());
    ...
    EvaluateResult secondContextResult =
        manager.evaluateFunctionInRealm(secondTabRealmId, "window.foo", true, Optional.empty());
  ...
  void canDisownHandles() {
    ...
    ArgumentValue value1 = new ArgumentValue(LocalValue.createObjectValue(localValueMap));
    ArgumentValue value2 =
        new ArgumentValue(
            new ReferenceValue(
  ...
  void canGetRealmInBrowsingContextByType() {
    ...
    List<RealmInfo> windowRealms =
        manager.getRealmsInBrowsingContextByType(windowId, RealmType.WINDOW);
