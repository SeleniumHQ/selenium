...
class PlatformTest {
  ...
  void testWindows8Detection() {
    assertThat(Platform.extractFromSysProperty("windows nt (unknown)", "6.2")).isEqualTo(
      Platform.WIN8);
  }

  @Test
  void testWindows81Detection() {
    assertThat(Platform.extractFromSysProperty("windows nt (unknown)", "6.3")).isEqualTo(
      Platform.WIN8_1);
  }
