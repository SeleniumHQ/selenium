...
public class DollarRentACarTest extends InternalSelenseTestBase {
  ...
  public void searchAndRent() throws InterruptedException {
    ...
    selenium.select("ctl05_ctl01_ResStartColumnLayout_LocationTime_CarTypeDropDownList",
        "label=Compact");
    ...
    selenium.waitForPageToLoad(TIMEOUT);
    selenium.select(
        "ctl04_ctl03_PersonalInformationColumnLayout_OptionsColumnLayout_LoyaltyProgramList",
