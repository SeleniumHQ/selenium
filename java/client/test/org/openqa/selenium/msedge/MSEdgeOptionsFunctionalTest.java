...
public class MSEdgeOptionsFunctionalTest extends JUnit4TestBase {

  private static final String EXT_PATH = "third_party/chrome_ext/backspace.crx";

  private MSEdgeDriver driver = null;
  ...
  @Test
  public void canStartMSEdgeWithCustomOptions() {
    MSEdgeOptions options = new MSEdgeOptions();
    options.addArguments("user-agent=foo;bar");
    driver = new MSEdgeDriver(options);
  ...
  public void optionsStayEqualAfterSerialization() {
    MSEdgeOptions options1 = new MSEdgeOptions();
    MSEdgeOptions options2 = new MSEdgeOptions();
