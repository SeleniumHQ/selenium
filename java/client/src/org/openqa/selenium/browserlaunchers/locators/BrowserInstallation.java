...
public class BrowserInstallation {
  ...
  /**
   * Checks to see if a Safari installation is found.
   * @return <code>true</code> if found.
   */
  ...
  /**
   * Get the path where the Safari installation is found.
   * @return <code>{@link String}</code> of the path.
   */
  ...
  public static boolean isInternetExplorerInstalled() {
    ...
    return new File(internetExplorerLocator.findBrowserLocationOrFail().launcherFilePath()).exists();
  }
  ...
  public static String getInternetExplorerInstallationBinary() {
    if (isInternetExplorerInstalled())
      return internetExplorerLocator.findBrowserLocationOrFail().launcherFilePath();
