 ...
 * {@link RemoteWebDriver} coupled with the desired {@link ChromiumDriverService}, which is managed
 * separately.
 *
...
public class ChromiumDriver extends RemoteWebDriver
  ...
  /**
   * Creates a new ChromiumDriver instance. The {@code service} will be started along with the
   * driver, and shutdown upon calling {@link #quit()}.
   *
   * @param service      The service to use.
   * @param capabilities The capabilities required from the ChromiumDriver.
   * @deprecated Use {@link ChromiumDriver(ChromeDriverService, ChromeOptions)} instead.
   */
  @Deprecated
  public ChromiumDriver(ChromiumDriverCommandExecutor commandExecutor, Capabilities capabilities) {
    ...
    connection = ChromiumDevToolsLocator.getChromiumConnector(
        factory,
        getCapabilities());
  }
