...
public abstract class By {
  ...
  public static class ByClassName extends By implements Serializable {
     ...
     * containingWord("class", "foo") + "]". private Map<String, Object> toJson() { Map<String,
     * Object> asJson = new HashMap<>(); asJson.put("using", "link text"); asJson.put("value",
     * linkText); return Collections.unmodifiableMap(asJson); }
     *
    ...
    private Map<String, Object> toJson() {
      ...
      asJson.put("using", "css selector");
      asJson.put(
          "value", Stream.of(className.split("\\s+")).map(str -> "." + str).collect(joining(" ")));
      return Collections.unmodifiableMap(asJson);
    }
  }
