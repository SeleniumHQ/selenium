...
public enum Keys implements CharSequence {
  ...
  ENTER('\uE007'),
  SHIFT('\uE008'),
  LEFT_SHIFT(SHIFT.keyCode), // alias
  CONTROL('\uE009'),
  LEFT_CONTROL(CONTROL.keyCode), // alias
  ALT('\uE00A'),
  LEFT_ALT(ALT.keyCode), // alias
  PAUSE('\uE00B'),
  ESCAPE('\uE00C'),
  SPACE('\uE00D'),
  PAGE_UP('\uE00E'),
  ...
  HOME('\uE011'),
  LEFT('\uE012'),
  ARROW_LEFT(LEFT.keyCode), // alias
  UP('\uE013'),
  ARROW_UP(UP.keyCode), // alias
  RIGHT('\uE014'),
  ARROW_RIGHT(RIGHT.keyCode), // alias
  DOWN('\uE015'),
  ARROW_DOWN(DOWN.keyCode), // alias
  INSERT('\uE016'),
  DELETE('\uE017'),
  SEMICOLON('\uE018'),
  EQUALS('\uE019'),
  ...
  public String toString() {
    return String.format("%s (\\u%04X)", name(), (int) keyCode);
  }
