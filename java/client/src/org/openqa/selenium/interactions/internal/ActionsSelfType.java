...
/**
 * Abstract parent class that defines an implementation
 * of the Builder design pattern using the self type
 * expressed as a Java generic type. For the concrete subclass
 * see {@link org.openqa.selenium.interactions.Actions}.
 */
public abstract class ActionsSelfType<T extends ActionsSelfType<T>>  {
   ...
   */
  public ActionsSelfType(WebDriver driver) {
   ...
   * @param keyboard the {@link org.openqa.selenium.interactions.Keyboard} implementation to delegate to.
   * @param mouse the {@link org.openqa.selenium.interactions.Mouse} implementation to delegate to.
   */
  public ActionsSelfType(Keyboard keyboard, Mouse mouse) {
    this.mouse = mouse;
   ...
   */
  public ActionsSelfType(Keyboard keyboard) {
    this.keyboard = keyboard;
    resetCompositeAction();
  }
   ...
   * @param theKey Either {@link org.openqa.selenium.Keys#SHIFT}, {@link org.openqa.selenium.Keys#ALT} or {@link org.openqa.selenium.Keys#CONTROL}. If the
   * provided key is none of those, {@link IllegalArgumentException} is thrown.
   * @return A self reference.
   */
  public T keyDown(Keys theKey) {
   ...
   * @return A self reference.
   */
  public T keyDown(WebElement element, Keys theKey) {
   ...
   * behaviour.
   *
   * @param theKey Either {@link org.openqa.selenium.Keys#SHIFT}, {@link org.openqa.selenium.Keys#ALT} or {@link org.openqa.selenium.Keys#CONTROL}.
   * @return A self reference.
   */
  public T keyUp(Keys theKey) {
   ...
   * @return A self reference.
   */
  public T keyUp(WebElement element, Keys theKey) {
   ...
   * {@link org.openqa.selenium.WebElement#sendKeys(CharSequence...)} on the active element in two ways:
   * <ul>
   ...
   * {@link ActionsSelfType#sendKeys(CharSequence...)} for details how.
   *
   ...
   * @return A self reference.
   */
  public T sendKeys(WebElement element, CharSequence... keysToSend) {
   ...
   * @return A self reference.
   */
  public T clickAndHold(WebElement onElement) {
   ...
   * @return A self reference.
   */
  public T release(WebElement onElement) {
   ...
   * @return A self reference.
   */
  public T click(WebElement onElement) {
   ...
   * @return A self reference.
   */
  public T doubleClick(WebElement onElement) {
   ...
   * @return A self reference.
   */
  public T moveToElement(WebElement toElement) {
   ...
   * @return A self reference.
   */
  public T moveToElement(WebElement toElement, int xOffset, int yOffset) {
   ...
   * @return A self reference.
   * @throws org.openqa.selenium.interactions.MoveTargetOutOfBoundsException if the provided offset is outside the document's
   * boundaries.
   */
   ...
   * @return A self reference.
   */
  public T contextClick(WebElement onElement) {
