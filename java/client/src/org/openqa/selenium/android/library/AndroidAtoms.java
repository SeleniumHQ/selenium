...
public enum AndroidAtoms {
  ...
  FIND_ELEMENT(
    ...
    "odeType?c:k};O.e=function(a,b){a||g(Error(\"No selector specified\"));O.j(a)&&g(Error(\"Comp" +
    ...
    ".d||0;this.a&&(this.depth*=-1);this.q=!c}r(Q,Ha);m=Q.prototype;m.c=k;m.d=0;m.o=l;function R(" +
    "a,b,c){if(a.c=b)a.d=\"number\"==typeof c?c:1!=a.c.nodeType?0:a.a?-1:1}\nm.next=function(){va" +
    "r a;if(this.o){(!this.c||this.q&&0==this.depth)&&g(Ga);a=this.c;var b=this.a?-1:1;if(this.d=" +
    "=b){var c=this.a?a.lastChild:a.firstChild;c?R(this,c):R(this,a,-1*b)}else(c=this.a?a.previou" +
    "sSibling:a.nextSibling)?R(this,c):R(this,a.parentNode,-1*b);this.depth+=this.d*(this.a?-1:1)" +
    "}else this.o=j;(a=this.c)||g(Ga);return a};\nm.splice=function(a){var b=this.c,c=this.a?1:-1" +
    ";this.d==c&&(this.d=-1*c,this.depth+=this.d*(this.a?-1:1));this.a=!this.a;Q.prototype.next.c" +
    ...
    "ction(){do Ia.t.next.call(this);while(-1==this.d);return this.c};function Ja(a,b){var c=G(a)" +
    ...
    "rn b};var W={},X={};W.n=function(a,b,c){b=J(E(b),\"A\",k,b);return C(b,function(b){b=Ra(b);r" +
    "eturn c&&-1!=b.indexOf(a)||b==a})};W.m=function(a,b,c){b=J(E(b),\"A\",k,b);return A(b,functi" +
    "on(b){b=Ra(b);return c&&-1!=b.indexOf(a)||b==a})};W.b=function(a,b){return W.n(a,b,l)};W.e=f" +
    "unction(a,b){return W.m(a,b,l)};X.b=function(a,b){return W.n(a,b,j)};X.e=function(a,b){retur" +
    "n W.m(a,b,j)};var Va={b:function(a,b){return b.getElementsByTagName(a)[0]||k},e:function(a,b" +
    "){return b.getElementsByTagName(a)}};var Wa={className:N,\"class name\":N,css:O,\"css select" +
    "or\":O,id:{b:function(a,b){var c=E(b),d=p(a)?c.k.getElementById(a):a;if(!d)return k;if(T(d," +
    "\"id\")==a&&I(b,d))return d;c=J(c,\"*\");return C(c,function(c){return T(c,\"id\")==a&&I(b,c" +
    ")})},e:function(a,b){var c=J(E(b),\"*\",k,b);return A(c,function(b){return T(b,\"id\")==a})}" +
    "},linkText:W,\"link text\":W,name:{b:function(a,b){var c=J(E(b),\"*\",k,b);return C(c,functi" +
    "on(b){return T(b,\"name\")==a})},e:function(a,b){var c=J(E(b),\"*\",k,b);return A(c,function" +
    "(b){return T(b,\n\"name\")==a})}},partialLinkText:X,\"partial link text\":X,tagName:Va,\"tag" +
    " name\":Va,xpath:P};function Xa(a,b){var c;a:{for(c in a)if(a.hasOwnProperty(c))break a;c=k}" +
    "if(c){var d=Wa[c];if(d&&\"function\"==o(d.b))return d.b(a[c],b||w.document)}g(Error(\"Unsupp" +
    "orted locator strategy: \"+c))};function Ya(a,b,c){var d={};d[a]=b;var a=[d,c],b=Xa,e;try{va" +
    "r b=p(b)?new w.Function(b):w==window?b:new w.Function(\"return (\"+b+\").apply(null,argument" +
    "s);\"),f=Da(a,w.document),h=b.apply(k,f);e={status:0,value:M(h)}}catch(q){e={status:\"code\"" +
    "in q?q.code:13,value:{message:q.message}}}f=[];L(new ya,e,f);return f.join(\"\")}var Y=[\"_" +
    "\"],Z=n;!(Y[0]in Z)&&Z.execScript&&Z.execScript(\"var \"+Y[0]);for(var $;Y.length&&($=Y.shif" +
    "t());)!Y.length&&Ya!==i?Z[$]=Ya:Z=Z[$]?Z[$]:Z[$]={};; return this._.apply(null,arguments);}." +
  ...
  FIND_ELEMENTS(
    ...
    "rn b};var W={},X={};W.n=function(a,b,c){b=J(E(b),\"A\",k,b);return C(b,function(b){b=Ra(b);r" +
    "eturn c&&-1!=b.indexOf(a)||b==a})};W.m=function(a,b,c){b=J(E(b),\"A\",k,b);return A(b,functi" +
    "on(b){b=Ra(b);return c&&-1!=b.indexOf(a)||b==a})};W.d=function(a,b){return W.n(a,b,l)};W.b=f" +
    "unction(a,b){return W.m(a,b,l)};X.d=function(a,b){return W.n(a,b,j)};X.b=function(a,b){retur" +
    "n W.m(a,b,j)};var Va={d:function(a,b){return b.getElementsByTagName(a)[0]||k},b:function(a,b" +
    "){return b.getElementsByTagName(a)}};var Wa={className:N,\"class name\":N,css:O,\"css select" +
    "or\":O,id:{d:function(a,b){var c=E(b),d=p(a)?c.k.getElementById(a):a;if(!d)return k;if(T(d," +
    "\"id\")==a&&I(b,d))return d;c=J(c,\"*\");return C(c,function(c){return T(c,\"id\")==a&&I(b,c" +
    ")})},b:function(a,b){var c=J(E(b),\"*\",k,b);return A(c,function(b){return T(b,\"id\")==a})}" +
    "},linkText:W,\"link text\":W,name:{d:function(a,b){var c=J(E(b),\"*\",k,b);return C(c,functi" +
    "on(b){return T(b,\"name\")==a})},b:function(a,b){var c=J(E(b),\"*\",k,b);return A(c,function" +
    "(b){return T(b,\n\"name\")==a})}},partialLinkText:X,\"partial link text\":X,tagName:Va,\"tag" +
    " name\":Va,xpath:P};function Xa(a,b){var c;a:{for(c in a)if(a.hasOwnProperty(c))break a;c=k}" +
    "if(c){var d=Wa[c];if(d&&\"function\"==o(d.b))return d.b(a[c],b||w.document)}g(Error(\"Unsupp" +
    "orted locator strategy: \"+c))};function Ya(a,b,c){var d={};d[a]=b;var a=[d,c],b=Xa,e;try{va" +
  ...
  FRAME_BY_ID_OR_NAME(
    ...
    "ty\");c&&(b=Number(c));(a=Ca(a))&&(b*=Fa(a));return b};var U={},V={};U.n=function(a,b,c){b=H" +
    "(D(b),\"A\",k,b);return B(b,function(b){b=Ha(b);return c&&-1!=b.indexOf(a)||b==a})};U.m=func" +
    "tion(a,b,c){b=H(D(b),\"A\",k,b);return z(b,function(b){b=Ha(b);return c&&-1!=b.indexOf(a)||b" +
    "==a})};U.d=function(a,b){return U.n(a,b,l)};U.b=function(a,b){return U.m(a,b,l)};V.d=functio" +
    "n(a,b){return U.n(a,b,j)};V.b=function(a,b){return U.m(a,b,j)};var La={d:function(a,b){retur" +
    "n b.getElementsByTagName(a)[0]||k},b:function(a,b){return b.getElementsByTagName(a)}};var Ma" +
    "={className:J,\"class name\":J,css:K,\"css selector\":K,id:{d:function(a,b){var c=D(b),d=p(a" +
    ")?c.k.getElementById(a):a;if(!d)return k;if(R(d,\"id\")==a&&G(b,d))return d;c=H(c,\"*\");ret" +
    "urn B(c,function(c){return R(c,\"id\")==a&&G(b,c)})},b:function(a,b){var c=H(D(b),\"*\",k,b)" +
    ";return z(c,function(b){return R(b,\"id\")==a})}},linkText:U,\"link text\":U,name:{d:functio" +
    "n(a,b){var c=H(D(b),\"*\",k,b);return B(c,function(b){return R(b,\"name\")==a})},b:function(" +
    "a,b){var c=H(D(b),\"*\",k,b);return z(c,function(b){return R(b,\n\"name\")==a})}},partialLin" +
    "kText:V,\"partial link text\":V,tagName:La,\"tag name\":La,xpath:M};function Na(a,b){var c=b" +
    "||w,d=c.frames[a];if(d)return d.document?d:d.contentWindow||(d.contentDocument||d.contentWin" +
    "dow.document).parentWindow||(d.contentDocument||d.contentWindow.document).defaultView;var e;" +
    "a:{var d={id:a},f;b:{for(f in d)if(d.hasOwnProperty(f))break b;f=k}if(f){var h=Ma[f];if(h&&" +
    "\"function\"==o(h.b)){e=h.b(d[f],c.document||w.document);break a}}g(Error(\"Unsupported loca" +
    "tor strategy: \"+f))}for(c=0;c<e.length;c++)if(Q(e[c],\"FRAME\")||Q(e[c],\"IFRAME\"))return " +
    "e[c].contentWindow||(e[c].contentDocument||\ne[c].contentWindow.document).parentWindow||(e[c" +
    "].contentDocument||e[c].contentWindow.document).defaultView;return k};v();v();function W(a,b" +
    "){this.type=a;this.currentTarget=this.target=b}r(W,function(){});W.prototype.r=l;W.prototype" +
    ".s=j;function Oa(a,b){if(a){var c=this.type=a.type;W.call(this,c);this.target=a.target||a.sr" +
    "cElement;this.currentTarget=b;var d=a.relatedTarget;d||(\"mouseover\"==c?d=a.fromElement:\"m" +
    "ouseout\"==c&&(d=a.toElement));this.relatedTarget=d;this.offsetX=a.offsetX!==i?a.offsetX:a.l" +
    "ayerX;this.offsetY=a.offsetY!==i?a.offsetY:a.layerY;this.clientX=a.clientX!==i?a.clientX:a.p" +
    "ageX;this.clientY=a.clientY!==i?a.clientY:a.pageY;this.screenX=a.screenX||0;this.screenY=a.s" +
    "creenY||0;this.button=a.button;this.keyCode=a.keyCode||\n0;this.charCode=a.charCode||(\"keyp" +
    "ress\"==c?a.keyCode:0);this.ctrlKey=a.ctrlKey;this.altKey=a.altKey;this.shiftKey=a.shiftKey;" +
    "this.metaKey=a.metaKey;this.state=a.state;delete this.s;delete this.r}}r(Oa,W);m=Oa.prototyp" +
    "e;m.target=k;m.relatedTarget=k;m.offsetX=0;m.offsetY=0;m.clientX=0;m.clientY=0;m.screenX=0;m" +
    ".screenY=0;m.button=0;m.keyCode=0;m.charCode=0;m.ctrlKey=l;m.altKey=l;m.shiftKey=l;m.metaKey" +
    "=l;function Pa(){this.f=i}\nfunction Qa(a,b,c){switch(typeof b){case \"string\":Ra(b,c);brea" +
    ...
    "reak}if(\"array\"==o(b)){var d=b.length;c.push(\"[\");for(var e=\"\",f=0;f<d;f++)c.push(e),e" +
    "=b[f],Qa(a,a.f?a.f.call(b,\"\"+f,e):e,c),e=\",\";c.push(\"]\");break}c.push(\"{\");d=\"\";fo" +
    "r(f in b)Object.prototype.hasOwnProperty.call(b,f)&&(e=b[f],\"function\"!=typeof e&&(c.push(" +
    "d),Ra(f,c),\nc.push(\":\"),Qa(a,a.f?a.f.call(b,f,e):e,c),d=\",\"));c.push(\"}\");break;case " +
    "\"function\":break;default:g(Error(\"Unknown type: \"+typeof b))}}var Sa={'\"':'\\\\\"',\"" +
    "\\\\\":\"\\\\\\\\\",\"/\":\"\\\\/\",\"\\u0008\":\"\\\\b\",\"\\u000c\":\"\\\\f\",\"\\n\":\"" +
    "\\\\n\",\"\\r\":\"\\\\r\",\"\\t\":\"\\\\t\",\"\\x0B\":\"\\\\u000b\"},Ta=/\\uffff/.test(\"\\u" +
    "ffff\")?/[\\\\\\\"\\x00-\\x1f\\x7f-\\uffff]/g:/[\\\\\\\"\\x00-\\x1f\\x7f-\\xff]/g;\nfunction" +
    " Ra(a,b){b.push('\"',a.replace(Ta,function(a){if(a in Sa)return Sa[a];var b=a.charCodeAt(0)," +
    "e=\"\\\\u\";16>b?e+=\"000\":256>b?e+=\"00\":4096>b&&(e+=\"0\");return Sa[a]=e+b.toString(16)" +
    "}),'\"')};function X(a){switch(o(a)){case \"string\":case \"number\":case \"boolean\":return" +
    " a;case \"function\":return a.toString();case \"array\":return A(a,X);case \"object\":if(\"n" +
    "odeType\"in a&&(1==a.nodeType||9==a.nodeType)){var b={};b.ELEMENT=Ua(a);return b}if(\"docume" +
    "nt\"in a)return b={},b.WINDOW=Ua(a),b;if(aa(a))return A(a,X);a=pa(a,function(a,b){return\"nu" +
    "mber\"==typeof b||p(b)});return qa(a,X);default:return k}}\nfunction Va(a,b){return\"array\"" +
    "==o(a)?A(a,function(a){return Va(a,b)}):ba(a)?\"function\"==typeof a?a:\"ELEMENT\"in a?Wa(a." +
    "ELEMENT,b):\"WINDOW\"in a?Wa(a.WINDOW,b):qa(a,function(a){return Va(a,b)}):a}function Xa(a){" +
    "var a=a||document,b=a.$wdc_;b||(b=a.$wdc_={},b.g=ca());b.g||(b.g=ca());return b}function Ua(" +
    "a){var b=Xa(a.ownerDocument),c=ra(b,function(b){return b==a});c||(c=\":wdc:\"+b.g++,b[c]=a);" +
    "return c}\nfunction Wa(a,b){var a=decodeURIComponent(a),c=b||document,d=Xa(c);a in d||g(new " +
    "L(10,\"Element does not exist in cache\"));var e=d[a];if(\"setInterval\"in e)return e.closed" +
    "&&(delete d[a],g(new L(23,\"Window has been closed.\"))),e;for(var f=e;f;){if(f==c.documentE" +
    "lement)return e;f=f.parentNode}delete d[a];g(new L(10,\"Element is no longer attached to the" +
    " DOM\"))};function Ya(a,b){var c=[a,b],d=Na,e;try{var d=p(d)?new w.Function(d):w==window?d:n" +
    "ew w.Function(\"return (\"+d+\").apply(null,arguments);\"),f=Va(c,w.document),h=d.apply(k,f)" +
    ";e={status:0,value:X(h)}}catch(q){e={status:\"code\"in q?q.code:13,value:{message:q.message}" +
    "}}c=[];Qa(new Pa,e,c);return c.join(\"\")}var Y=[\"_\"],Z=n;!(Y[0]in Z)&&Z.execScript&&Z.exe" +
    "cScript(\"var \"+Y[0]);for(var $;Y.length&&($=Y.shift());)!Y.length&&Ya!==i?Z[$]=Ya:Z=Z[$]?Z" +
    "[$]:Z[$]={};; return this._.apply(null,arguments);}.apply({navigator:typeof window!='undefin" +
