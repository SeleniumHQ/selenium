...
public class V85Runtime implements RuntimeDomain {
  ...
  public Command<Void> enable() {
    return org.openqa.selenium.devtools.v85.runtime.Runtime.enable();
  }

  @Override
  public Event<org.openqa.selenium.devtools.idealized.runtime.model.ConsoleAPICalled> consoleAPICalled() {
    return new Event<>(
      org.openqa.selenium.devtools.v85.runtime.Runtime.consoleAPICalled().getMethod(),
      input -> {
        ConsoleAPICalled v85 = input.read(ConsoleAPICalled.class);
        // Elegant, no? No.
        long ts = new BigDecimal(v85.getTimestamp().toJson()).longValue();

        List<Object> modifiedArgs = v85.getArgs().stream()
