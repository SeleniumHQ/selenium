...
import org.openqa.selenium.devtools.v86.runtime.model.ExceptionDetails;
import org.openqa.selenium.devtools.v86.runtime.model.ExceptionThrown;
import org.openqa.selenium.devtools.v86.runtime.model.StackTrace;
...
public class V86Events extends Events<ConsoleAPICalled, ExceptionThrown> {
  ...
  public V86Events(DevTools devtools) {
    super(devtools);
  }
