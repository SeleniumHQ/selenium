...
public class DomStorageItemRemoved {
  ...
  private DomStorageItemRemoved(StorageId storageId, String key) {
    this.storageId = requireNonNull(storageId, "'storageId' is required for DomStorageItemRemoved");
    this.key = requireNonNull(key, "'key' is required for DomStorageItemRemoved");
  }
