...
/**
 * Provided for compatibility with Selenium Grid 1.0 clients. Responds to
 * heartbeat requests and indicates whether or not a node is registered with the
 * hub.
 */
public class Grid1HeartbeatServlet extends RegistryBasedServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    // Build up the proxy URL based upon the params the Grid 1.0 node will pass
    // as query params.
    Map<String, String[]> queryParams = request.getParameterMap();
    String nodeUrl = String.format("http://%s:%s", queryParams.get("host")[0],
