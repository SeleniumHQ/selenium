...
class SeleniumHttpsInitializer extends ChannelInitializer<SocketChannel> {

  private HttpHandler seleniumHandler;
  private SslContext sslCtx;

  SeleniumHttpsInitializer(HttpHandler seleniumHandler, SslContext sslCtx) {
    this.seleniumHandler = Objects.requireNonNull(seleniumHandler);
    this.sslCtx = Objects.requireNonNull(sslCtx);
  }
