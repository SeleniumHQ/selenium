...
public class SetSessionStorageItem extends WebDriverHandler<Void> implements JsonParametersAware {
  ...
  public String toString() {
    return String.format("[Set session storage item pair: (%s, %s)]", key, value);
  }
}
