...
/**
 * create mocked object for testing grid internal. Objects will have all the normal object
 * characteristics, and will reserve/release the resources on the hub, but will not forward the
...
public class GridHelper {
  ...
  //
  //
  //  public static MockedRequestHandler createStopSessionHandler(GridRegistry registry, TestSession
  // session) {
  //    SeleniumBasedRequest request = createMockedRequest(registry, RequestType.STOP_SESSION,
  // null);
