 ...
 *
 * <p>For a hub capable of handling 1 FF and 1 IE for instance, if the hub already built a queue of
 * FF requests and a IE request is received it should be processed right away and not blocked by the
 * FF queue.
 */
public class ConcurrencyLockTest {
  ...
  //
  //    RemoteProxy p1 = RemoteProxyFactory.getNewBasicRemoteProxy(ie, "http://machine1:4444",
  // registry);
  //    RemoteProxy p2 = RemoteProxyFactory.getNewBasicRemoteProxy(ff, "http://machine2:4444",
  // registry);
  //    registry.add(p1);
  //    registry.add(p2);
  //
