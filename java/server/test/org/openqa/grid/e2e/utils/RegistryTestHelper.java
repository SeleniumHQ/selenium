...
public class RegistryTestHelper {
  ...
  //
  //
  //  public static void waitForActiveTestSessionCount(final GridRegistry r, final int
  // activeTestSessions) {
  //    newWait().until(input -> {
  ...
  //  }
  //
  //  public static void waitForNewSessionRequestCount(final GridRegistry r, final int
