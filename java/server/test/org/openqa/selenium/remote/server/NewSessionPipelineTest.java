...
public class NewSessionPipelineTest {
  ...
  public void shouldUseMutators() {
    ...
    //    ));
    //
    //    ImmutableMap<String, ImmutableMap<String, ImmutableMap<String, String>>> caps =
    // ImmutableMap.of(
    //        "capabilities", ImmutableMap.of(
    //            "alwaysMatch", ImmutableMap.of("browserName", "firefox")));
    //
    ...
    //
    //    pipeline.createNewSession(NewSessionPayload.create(caps));
    //    verify(factory).apply(argThat(req ->
    // req.getCapabilities().getCapability("marionette").equals(true)));
  }
