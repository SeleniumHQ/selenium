...
public class ClassPathResourceTest {
  ...
  public void shouldGetASingleFile() {
    URL res = getClass().getResource("/server/test/org/openqa/selenium/grid/web");
    assertThat(res).isNotNull();

    Resource resource = new ClassPathResource(res, "server/test/org/openqa/selenium/grid/web");
    assertThat(resource.isDirectory()).isTrue();

    Optional<Resource> found = resource.get("packaged-file.txt");
