...
goog.provide('goog.labs.i18n.ListFormatSymbols_yue_HK');
...
/**
 * List formatting symbols for locale yue_HK.
 */
goog.labs.i18n.ListFormatSymbols_yue_HK = {
  GENDER_STYLE: 0,
  LIST_TWO: '{0}同{1}',
  LIST_START: '{0}、{1}',
  LIST_MIDDLE: '{0}、{1}',
...
if (goog.LOCALE == 'yue_HK' || goog.LOCALE == 'yue-HK') {
  goog.labs.i18n.ListFormatSymbols = goog.labs.i18n.ListFormatSymbols_yue_HK;
}
