 ...
 */
goog.provide('goog.locale.DateTimeParse');
 ...
 * @type {number}
 */
goog.locale.DateTimeParse.prototype.year = 0;
 ...
 * @type {number}
 */
goog.locale.DateTimeParse.prototype.month = 0;
 ...
 * @type {number}
 */
goog.locale.DateTimeParse.prototype.dayOfMonth = 0;
 ...
 * @type {number}
 */
goog.locale.DateTimeParse.prototype.hours = 0;
 ...
 * @type {number}
 */
goog.locale.DateTimeParse.prototype.minutes = 0;
 ...
 * @type {number}
 */
goog.locale.DateTimeParse.prototype.seconds = 0;
 ...
 * @type {number}
 */
goog.locale.DateTimeParse.prototype.milliseconds = 0;
...
goog.locale.DateTimeParse.prototype.applyPattern = function(pattern) {
  ...
  for (var i = 0; i < pattern.length; i++) {
    ...
    } else if (goog.locale.DateTimeParse.PATTERN_CHARS_.indexOf(ch) >= 0) {
 ...
 * @deprecated Use goog.i18n.DateTimeParse.
 */
goog.locale.DateTimeParse.prototype.applyStandardPattern = function(formatType)
{
  var pattern;
  ...
  if (formatType < 4) {
    ...
    return this.applyStandardPattern(goog.locale.MEDIUM_DATETIME_FORMAT);
  }
...
goog.locale.DateTimeParse.prototype.strictParse = function(text, start, date) {
  ...
  return this.internalParse_(text, start, date, true/*validation*/);
};
 ...
 * @private
 */
goog.locale.DateTimeParse.prototype.subParse_ =
 ...
 * @private
 */
goog.locale.DateTimeParse.MyDate_.prototype.year;
 ...
 * @type {number|undefined}
 */
goog.locale.DateTimeParse.MyDate_.prototype.dayOfMonth;
