...
class NS_NO_VTABLE NS_SCRIPTABLE nsINativeEvents : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HasUnhandledEvents(nsISupports *aNode, bool *hasEvents NS_OUTPARAM) = 0;
...
#define NS_DECL_NSINATIVEEVENTS \
  NS_SCRIPTABLE NS_IMETHOD HasUnhandledEvents(nsISupports *aNode, bool *hasEvents NS_OUTPARAM); \
...
#define NS_FORWARD_NSINATIVEEVENTS(_to) \
  NS_SCRIPTABLE NS_IMETHOD HasUnhandledEvents(nsISupports *aNode, bool *hasEvents NS_OUTPARAM) { return _to HasUnhandledEvents(aNode, hasEvents); } \
...
#define NS_FORWARD_SAFE_NSINATIVEEVENTS(_to) \
  NS_SCRIPTABLE NS_IMETHOD HasUnhandledEvents(nsISupports *aNode, bool *hasEvents NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasUnhandledEvents(aNode, hasEvents); } \
...
/* void hasUnhandledEvents (in nsISupports aNode, out boolean hasEvents); */
NS_IMETHODIMP nsNativeEvents::HasUnhandledEvents(nsISupports *aNode, bool *hasEvents NS_OUTPARAM)
{
