...
class NS_NO_VTABLE NS_SCRIPTABLE nsINativeKeyboard : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SendKeys(nsISupports *aNode, const PRUnichar * value, bool releaseModifiers) = 0;
...
#define NS_DECL_NSINATIVEKEYBOARD \
  NS_SCRIPTABLE NS_IMETHOD SendKeys(nsISupports *aNode, const PRUnichar * value, bool releaseModifiers); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSINATIVEKEYBOARD(_to) \
  NS_SCRIPTABLE NS_IMETHOD SendKeys(nsISupports *aNode, const PRUnichar * value, bool releaseModifiers) { return _to SendKeys(aNode, value, releaseModifiers); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSINATIVEKEYBOARD(_to) \
  NS_SCRIPTABLE NS_IMETHOD SendKeys(nsISupports *aNode, const PRUnichar * value, bool releaseModifiers) { return !_to ? NS_ERROR_NULL_POINTER : _to->SendKeys(aNode, value, releaseModifiers); } 
