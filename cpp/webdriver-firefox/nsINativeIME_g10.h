/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM cpp\webdriver-firefox\nsINativeIME.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINativeIME : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ImeActivateEngine(const char * engine, bool *activationSucceeded NS_OUTPARAM) = 0;

  /* void imeIsActivated (out boolean isActive); */
  NS_SCRIPTABLE NS_IMETHOD ImeIsActivated(bool *isActive NS_OUTPARAM) = 0;
...
#define NS_DECL_NSINATIVEIME \
  ...
  NS_SCRIPTABLE NS_IMETHOD ImeActivateEngine(const char * engine, bool *activationSucceeded NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD ImeIsActivated(bool *isActive NS_OUTPARAM); \
...
#define NS_FORWARD_NSINATIVEIME(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ImeActivateEngine(const char * engine, bool *activationSucceeded NS_OUTPARAM) { return _to ImeActivateEngine(engine, activationSucceeded); } \
  NS_SCRIPTABLE NS_IMETHOD ImeIsActivated(bool *isActive NS_OUTPARAM) { return _to ImeIsActivated(isActive); } \
...
#define NS_FORWARD_SAFE_NSINATIVEIME(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ImeActivateEngine(const char * engine, bool *activationSucceeded NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ImeActivateEngine(engine, activationSucceeded); } \
  NS_SCRIPTABLE NS_IMETHOD ImeIsActivated(bool *isActive NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ImeIsActivated(isActive); } \
...
/* void imeActivateEngine (in string engine, out boolean activationSucceeded); */
NS_IMETHODIMP nsNativeIME::ImeActivateEngine(const char * engine, bool *activationSucceeded NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void imeIsActivated (out boolean isActive); */
NS_IMETHODIMP nsNativeIME::ImeIsActivated(bool *isActive NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
