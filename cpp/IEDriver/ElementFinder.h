...
private:
	int FindElementByCssSelector(const Session& session, ElementHandle parent_wrapper, const std::wstring& criteria, Json::Value* found_element);
	...
	int FindElementByXPath(const Session& session, ElementHandle parent_wrapper, const std::wstring& criteria, Json::Value* found_element);
	int FindElementsByXPath(const Session& session, ElementHandle parent_wrapper, const std::wstring& criteria, Json::Value* found_elements);
