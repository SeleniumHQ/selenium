...
class ClearElementCommandHandler : public CommandHandler {
public:
...
protected:
	void ClearElementCommandHandler::ExecuteInternal(const IESessionWindow& session, const LocatorMap& locator_parameters, const ParametersMap& command_parameters, Response * response) {
