...
#ifndef WEBDRIVER_IE_RESTOREWINDOWCOMMANDHANDLER_H_
#define WEBDRIVER_IE_RESTOREWINDOWCOMMANDHANDLER_H_
...
class RestoreWindowCommandHandler : public IECommandHandler {
 public:
  RestoreWindowCommandHandler(void) {
  }

  virtual ~RestoreWindowCommandHandler(void) {
  }
...
#endif // WEBDRIVER_IE_RESTOREWINDOWCOMMANDHANDLER_H_
