...
class HoverOverElementCommandHandler : public CommandHandler {
public:
...
protected:
	void HoverOverElementCommandHandler::ExecuteInternal(const IESessionWindow& session, const LocatorMap& locator_parameters, const ParametersMap& command_parameters, Response * response) {
