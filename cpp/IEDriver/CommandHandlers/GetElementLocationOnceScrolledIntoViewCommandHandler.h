...
class GetElementLocationOnceScrolledIntoViewCommandHandler : public IECommandHandler {
 ...
 protected:
  void GetElementLocationOnceScrolledIntoViewCommandHandler::ExecuteInternal(const IECommandExecutor& executor,
    ...
    if (id_parameter_iterator == locator_parameters.end()) {
      ...
      if (status_code == SUCCESS) {
        ...
        status_code = element_wrapper->GetLocationOnceScrolledIntoView(&x,
                                                                       &y,
                                                                       &width,
                                                                       &height);
        if (status_code == SUCCESS) {
