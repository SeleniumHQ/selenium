...
class GetElementTagNameCommandHandler : public CommandHandler {
public:
...
protected:
	void GetElementTagNameCommandHandler::ExecuteInternal(const IESessionWindow& session, const LocatorMap& locator_parameters, const ParametersMap& command_parameters, Response * response) {
