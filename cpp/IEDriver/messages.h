...
#define WD_HANDLE_UNEXPECTED_ALERTS WM_APP + 14

#define WD_ASYNC_SCRIPT_SET_DOCUMENT WM_APP + 15
#define WD_ASYNC_SCRIPT_SET_ARGUMENT WM_APP + 16
#define WD_ASYNC_SCRIPT_GET_RESULT WM_APP + 17
#define WD_ASYNC_SCRIPT_IS_EXECUTION_COMPLETE WM_APP + 18
#define WD_ASYNC_SCRIPT_DETACH_LISTENTER WM_APP + 19