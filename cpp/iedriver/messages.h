...
#define WD_SCRIPT_WAIT WM_APP + 30

#define WD_ASYNC_SCRIPT_SET_DOCUMENT WM_APP + 16
#define WD_ASYNC_SCRIPT_SET_ELEMENT_ARGUMENT WM_APP + 17
...
#define WD_ASYNC_SCRIPT_GET_REQUIRED_ELEMENT_LIST WM_APP + 51
#define WD_ASYNC_SCRIPT_TRANSFER_MANAGED_ELEMENT WM_APP + 34
#define WD_ASYNC_SCRIPT_NOTIFY_ELEMENT_TRANSFERRED WM_APP + 41
#define WD_ASYNC_SCRIPT_SCHEDULE_REMOVE_MANAGED_ELEMENT WM_APP + 35

#define WD_ASYNC_SCRIPT_IS_EXECUTION_READY WM_APP + 53

#define WD_ASYNC_SCRIPT_SET_POLLING_SCRIPT WM_APP + 50
