...
#define WD_GET_SCRIPTABLE_COOKIES WM_APP + 30
#define WD_GET_HTTPONLY_COOKIES WM_APP + 31
#define WD_GET_SECURE_COOKIES WM_APP + 32
#define WD_GET_COOKIE_CACHE_FILES WM_APP + 33
#define WD_SET_COOKIE WM_APP + 34
