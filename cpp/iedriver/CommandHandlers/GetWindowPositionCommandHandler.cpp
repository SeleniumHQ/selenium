...
#include "GetWindowPositionCommandHandler.h"
...
GetWindowPositionCommandHandler::GetWindowPositionCommandHandler(void) {
}

GetWindowPositionCommandHandler::~GetWindowPositionCommandHandler(void) {
}

void GetWindowPositionCommandHandler::ExecuteInternal(
