 ...
 */
public class FirefoxChromeLauncherIntegrationTest extends TestCase {
    ...
    public void testLauncherWithDefaultConfiguration() throws Exception {
        final FirefoxChromeLauncher launcher;

        launcher = new FirefoxChromeLauncher(new RemoteControlConfiguration(), "CUSTFFCHROME");
