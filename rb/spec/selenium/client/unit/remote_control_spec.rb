...
describe Selenium::ServerControl::ServerControl do
  def mock_shell
  ...
  it "host returns the host provided in the contructor" do
    Selenium::ServerControl::ServerControl.new(:the_host, :a_port).host.should == :the_host
  end

  it "port returns the port provided in the contructor" do
    Selenium::ServerControl::ServerControl.new(:a_host, :the_port).port.should == :the_port
  end
  ...
  it "timeout_in_seconds returns 2 minutes by default" do
    Selenium::ServerControl::ServerControl.new(:a_host, :a_port).timeout_in_seconds.should == 2 * 60
  end
  ...
  it "jar_file is nil by default" do
    Selenium::ServerControl::ServerControl.new(:a_host, :a_port).jar_file.should be_nil
  end
  ...
  it "additional_args is empty by default" do
    Selenium::ServerControl::ServerControl.new(:a_host, :a_port).additional_args.should == []
  end
