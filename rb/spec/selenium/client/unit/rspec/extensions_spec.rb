...
describe Spec::Example::ExampleMethods do
  ...
  it "Example reporting_uid is the same when example is the same" do
  ...
  it "ExampleProxy reporting_uid are equals when Example is the same" do
  ...
  it "ExampleProxy reporting_uid are different when Example is not the same" do
  ...
  it "execution_error is exposed as an instance variable" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
    example.execution_error.should be_nil
  end

  it "actual_failure? returns false when execution_error is nil" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
  ...
  it "actual_failure? returns true when execution_error is a StandardError" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
  ...
  it "actual_failure? returns false when execution_error is an ExamplePendingError" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
  ...
  it "actual_failure? returns false when execution_error is an NotYetImplementedError" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
  ...
  it "actual_failure? returns false when execution_error is a PendingExampleFixedError" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
  ...
  it "actual_failure? returns false when execution_error is a NoDescriptionError" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
  ...
  it "pending_for_browsers yields the block when actual browser does not match any regexp" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
  ...
  it "pending_for_browsers calls pending when actual browser does match one of the regexp" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
  ...
  it "pending_for_browsers does not trigger test logic when actual browser does match one of the regexp" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
    example.stub!(:selenium_driver).and_return(mock(:browser_string => "*safari").as_null_object)
  ...
  it "pending_for_browsers can match multiple regexps" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
    example.stub!(:selenium_driver).and_return(mock(:browser_string => "*safari").as_null_object)
  ...
  it "pending_for_browsers regexp match is case insensitive" do
    example_class = Class.new { include Spec::Example::ExampleMethods }
    example = example_class.new(:a_proxy) do puts "some implementation" end
    example.stub!(:selenium_driver).and_return(mock(:browser_string => "*safari").as_null_object)
