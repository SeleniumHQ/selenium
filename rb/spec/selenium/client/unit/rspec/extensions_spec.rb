...
describe Spec::Example::ExampleMethods do
  ...
  describe "#reporting_uid" do
    it "is the same when example is the same" do # ???
      example = ExampleClass.new(:a_proxy) do puts "some implementation" end
    ...
    it "Example reporting_uid are not equals when implementation is different" do
      first_example = ExampleClass.new(:a_proxy) do puts "some implementation" end
      second_example = ExampleClass.new(:a_proxy) do puts "another implementation" end
