...
module Selenium
  describe Logger do
    ...
    describe '#deprecate' do
      ...
      it 'allows to deprecate with an expected version for removal' do
        message = /\[DEPRECATION\] #old is deprecated, and will be removed in vX\.Y\.Z\. Use #new instead\./
        expect { logger.deprecate('#old', '#new', version: 'vX.Y.Z') }.to output(message).to_stdout_from_any_process
      end
