  ...
  module WebDriver
    describe Credential do
      ...
      it 'can test_to_dict' do
        ...
        expect(@credential_dict[:userHandle]).to eq(Base64.urlsafe_encode64([1].to_s))

        BASE64URL_ENCODED_PK = BASE64_ENCODED_PK.gsub("+", "-").gsub("/", "_")
      ...
      it 'can test_from_dict' do
        @credential_data = {
          "credentialId" => Base64.urlsafe_encode64([1,2,3,4].to_s),
          "isResidentCredential" => true,
          "rpId" => 'localhost',
          "userHandle" => Base64.urlsafe_encode64([1].to_s),
