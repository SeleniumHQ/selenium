    ...
    module Support
      describe Select do
        ...
        describe '#select_by' do
          ...
          context 'when multiple select' do
            context 'when by text' do
              ...
              it 'errors when option disabled', exclude: { browser: :safari, reason: 'Safari raises no exception with disabled' } do
                expect {
        ...
        describe '#select_all' do
          ...
          it 'raises exception if select contains disabled options', exclude: { browser: :safari, reason: 'Safari raises no exception with disabled' } do
