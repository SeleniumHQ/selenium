...
class Selenium::WebDriver::Remote::Bridge
  ...
  command :doubleClickElement,              :post,    "session/:session_id/element/:id/doubleclick"
  command :contextClickElement,             :post,    "session/:session_id/element/:id/contextclick"
  command :mouseDownElement,                :post,    "session/:session_id/element/:id/buttondown"
  command :mouseUpElement,                  :post,    "session/:session_id/element/:id/buttonup"
  command :mouseMoveToElement,              :post,    "session/:session_id/element/:id/movehere"
