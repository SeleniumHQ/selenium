...
test('Status component for DRAINING', () => {
  const statusComp = shallow(<Status status={'UP'} selected={2}/>);
...
test('Tippy content css - IDLE', () => {
  const statusComp = shallow(<Status status={'IDLE'} selected={0}/>);
...
test('Tippy content css - DRAINING', () => {
  const statusComp = shallow(<Status status={'DRAINING'} selected={0}/>);
...
test('Tippy content css - UNAVAILABLE', () => {
  const statusComp = shallow(<Status status={'UNAVAILABLE'} selected={0}/>);
