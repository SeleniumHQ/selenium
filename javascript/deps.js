...
goog.addDependency("../../../javascript/firefox-driver/js/syntheticMouse.js", ['SyntheticMouse'], ['Utils', 'bot.ErrorCode', 'bot.Mouse', 'bot.action', 'bot.dom', 'bot.events', 'bot.window', 'fxdriver.moz', 'fxdriver.utils', 'fxdriver.Logger', 'goog.math.Coordinate']);
...
goog.addDependency("../../../javascript/webdriver-jsapi/testing/jsunit.js", ['webdriver.testing.jsunit', 'webdriver.testing.jsunit.TestRunner'], ['goog.json', 'goog.testing.TestRunner', 'webdriver.testing.TestCase']);
goog.addDependency("../../../javascript/webdriver-jsapi/testing/testcase.js", ['webdriver.testing.TestCase'], ['goog.array', 'goog.testing.TestCase', 'webdriver.testing.asserts', 'webdriver.promise.Application']);
