...
goog.addDependency("../../../javascript/atoms/action.js", ['bot.action'], ['bot', 'bot.Error', 'bot.ErrorCode', 'bot.Keyboard', 'bot.dom', 'bot.events', 'bot.userAgent', 'goog.Uri', 'goog.array', 'goog.dom', 'goog.dom.NodeType', 'goog.dom.TagName', 'goog.events.EventType', 'goog.userAgent', 'goog.userAgent.product.isVersion']);
...
goog.addDependency("../../../javascript/atoms/mouse.js", ['bot.Mouse', 'bot.Mouse.Button'], ['bot', 'bot.Error', 'bot.ErrorCode', 'bot.dom', 'bot.events', 'goog.dom', 'goog.dom.Range', 'goog.dom.TagName', 'goog.events.EventType', 'goog.math.Coordinate', 'goog.style', 'goog.userAgent']);
