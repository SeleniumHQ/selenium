...
goog.addDependency("../../../javascript/atoms/dom.js", ['bot.dom'], ['bot', 'bot.locators.xpath', 'bot.userAgent', 'bot.window', 'goog.array', 'goog.dom', 'goog.dom.NodeIterator', 'goog.dom.NodeType', 'goog.dom.TagName', 'goog.math.Coordinate', 'goog.math.Rect', 'goog.math.Size', 'goog.string', 'goog.style']);
...
goog.addDependency("../../../javascript/safari-driver/extension/tab.js", ['safaridriver.extension.Tab'], ['bot.response', 'goog.Uri', 'goog.debug.Logger', 'goog.string', 'webdriver.EventEmitter']);
...
goog.addDependency("../../../javascript/safari-driver/inject/inject.js", ['safaridriver.inject'], ['bot.ErrorCode', 'bot.response', 'goog.debug.Logger', 'webdriver.Command', 'webdriver.CommandName', 'webdriver.promise', 'safaridriver.Command', 'safaridriver.message', 'safaridriver.console', 'safaridriver.inject.PageMessenger', 'safaridriver.inject.commands', 'safaridriver.inject.state']);
goog.addDependency("../../../javascript/safari-driver/inject/messenger.js", ['safaridriver.inject.PageMessenger'], ['bot.response', 'goog.debug.Logger', 'safaridriver.inject.page', 'safaridriver.inject.state', 'safaridriver.message', 'webdriver.promise']);
goog.addDependency("../../../javascript/safari-driver/inject/page.js", ['safaridriver.inject.page'], ['bot.Error', 'bot.ErrorCode', 'bot.dom', 'bot.inject', 'bot.locators.xpath', 'bot.response', 'goog.array', 'goog.debug.Logger', 'goog.dom', 'goog.object', 'goog.string', 'goog.dom.classes', 'safaridriver.console', 'safaridriver.message', 'webdriver.CommandName', 'webdriver.promise']);
...
goog.addDependency("../../../javascript/webdriver/atoms/inputs.js", ['webdriver.atoms.inputs'], ['bot.Keyboard', 'bot.Mouse', 'bot.action', 'goog.array']);
