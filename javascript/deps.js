...
goog.addDependency("../../../javascript/atoms/touchscreen.js", ['bot.Touchscreen'], ['bot', 'goog.math.Coordinate']);
...
goog.addDependency("../../../javascript/firefox-driver/extension/components/syntheticMouse.js", ['SyntheticMouse'], ['Utils', 'bot.ErrorCode', 'bot.Mouse', 'bot.action', 'bot.dom', 'bot.events', 'fxdriver.moz', 'fxdriver.utils', 'fxdriver.Logger']);
...
goog.addDependency("../../../javascript/webdriver-atoms/inject/local_storage.js", ['webdriver.inject.storage.local'], ['bot.inject', 'webdriver.storage.local']);
...
goog.addDependency("../../../javascript/webdriver-jsapi/asserts.js", ['webdriver.asserts', 'webdriver.asserts.Matcher'], ['goog.array', 'webdriver.promise']);
goog.addDependency("../../../javascript/webdriver-jsapi/builder.js", ['webdriver.Builder'], ['goog.json', 'goog.string', 'webdriver.Command', 'webdriver.CommandName', 'webdriver.Session', 'webdriver.WebDriver', 'webdriver.error', 'webdriver.http.Executor', 'webdriver.http.Response', 'webdriver.http.XhrClient', 'webdriver.http.JsonpClient', 'webdriver.node.HttpClient', 'webdriver.process', 'webdriver.promise.Deferred']);
goog.addDependency("../../../javascript/webdriver-jsapi/command.js", ['webdriver.Command', 'webdriver.CommandExecutor', 'webdriver.CommandName'], []);
goog.addDependency("../../../javascript/webdriver-jsapi/error.js", ['webdriver.error'], ['bot.Error', 'bot.ErrorCode']);
goog.addDependency("../../../javascript/webdriver-jsapi/events.js", ['webdriver.EventEmitter'], []);
goog.addDependency("../../../javascript/webdriver-jsapi/jsunit.js", ['webdriver.jsunit', 'webdriver.jsunit.TestRunner'], ['goog.json', 'goog.testing.TestRunner', 'webdriver.TestCase']);
...
goog.addDependency("../../../javascript/webdriver-jsapi/process.js", ['webdriver.process'], ['goog.Uri', 'goog.array', 'goog.json']);
goog.addDependency("../../../javascript/webdriver-jsapi/promise.js", ['webdriver.promise', 'webdriver.promise.Application', 'webdriver.promise.Application.Frame_', 'webdriver.promise.Application.Task_', 'webdriver.promise.Deferred', 'webdriver.promise.Promise'], ['goog.array', 'goog.object', 'webdriver.EventEmitter']);
goog.addDependency("../../../javascript/webdriver-jsapi/testcase.js", ['webdriver.TestCase'], ['goog.testing.TestCase', 'webdriver.asserts', 'webdriver.promise.Application']);
goog.addDependency("../../../javascript/webdriver-jsapi/webdriver.js", ['webdriver.Key', 'webdriver.Session', 'webdriver.WebDriver', 'webdriver.WebDriver.Navigation', 'webdriver.WebDriver.Options', 'webdriver.WebDriver.TargetLocator', 'webdriver.WebDriver.Timeouts', 'webdriver.WebElement'], ['bot.ErrorCode', 'goog.array', 'goog.object', 'webdriver.Command', 'webdriver.CommandName', 'webdriver.Locator', 'webdriver.error', 'webdriver.promise', 'webdriver.promise.Application', 'webdriver.promise.Deferred', 'webdriver.promise.Promise']);
goog.addDependency("../../../javascript/webdriver-jsapi/http/http.js", ['webdriver.http.Client', 'webdriver.http.Executor', 'webdriver.http.Request', 'webdriver.http.Response'], ['bot.ErrorCode', 'goog.json', 'webdriver.CommandName', 'webdriver.WebElement', 'webdriver.promise.Deferred']);
goog.addDependency("../../../javascript/webdriver-jsapi/http/jsonpclient.js", ['webdriver.http.JsonpClient'], ['goog.dom', 'goog.json', 'webdriver.http.Response', 'webdriver.promise.Deferred']);
goog.addDependency("../../../javascript/webdriver-jsapi/http/xhrclient.js", ['webdriver.http.XhrClient'], ['goog.json', 'webdriver.http.Response', 'webdriver.promise.Deferred']);
goog.addDependency("../../../javascript/webdriver-jsapi/node/demo.js", [], []);
goog.addDependency("../../../javascript/webdriver-jsapi/node/node.js", ['webdriver.node', 'webdriver.node.HttpClient'], ['webdriver.http.Response', 'webdriver.promise.Deferred', 'webdriver.process']);
goog.addDependency("../../../javascript/webdriver-jsapi/node/optparse.js", [], []);
goog.addDependency("../../../javascript/webdriver-jsapi/test/testutil.js", [], ['goog.array', 'goog.json', 'goog.testing.MockClock']);
goog.addDependency("../../../javascript/webdriver-jsapi/test/e2e/testutil.js", [], []);
