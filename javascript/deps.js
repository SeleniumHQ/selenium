...
goog.addDependency("../../../javascript/firefox-driver/js/events.js", ['fxdriver.events'], ['Logger', 'Utils', 'fxdriver.utils', 'goog.style']);
goog.addDependency("../../../javascript/firefox-driver/js/exported_symbols.js", [], ['fxdriver.events']);
goog.addDependency("../../../javascript/firefox-driver/js/firefox-utils.js", ['fxdriver.utils'], ['bot.userAgent', 'bot.Error', 'bot.ErrorCode', 'goog.array', 'Logger']);
goog.addDependency("../../../javascript/firefox-driver/js/locators.js", ['webdriver.firefox.locators'], ['bot.locators', 'bot.userAgent', 'fxdriver.utils', 'goog.dom']);
goog.addDependency("../../../javascript/firefox-driver/js/logging.js", ['Logger', 'fxdriver.debug', 'fxdriver.debug.ConsoleFormatter'], ['goog.debug.Formatter', 'goog.debug.Logger', 'goog.debug.LogRecord', 'goog.debug.TextFormatter']);
goog.addDependency("../../../javascript/firefox-driver/js/modals.js", ['fxdriver.modals'], ['bot.ErrorCode', 'Logger', 'Timer', 'fxdriver.utils']);
...
goog.addDependency("../../../javascript/firefox-driver/js/utils.js", ['Utils'], ['bot.dom', 'bot.userAgent', 'goog.dom.TagName', 'goog.style', 'bot.ErrorCode', 'Logger']);
