...
goog.addDependency("../../../javascript/safari-driver/messagetarget.js", ['safaridriver.message.MessageTarget'], ['goog.debug.Logger', 'safaridriver.message', 'webdriver.EventEmitter']);
...
goog.addDependency("../../../javascript/safari-driver/extension/tab.js", ['safaridriver.extension.Tab'], ['bot.response', 'goog.Uri', 'safaridriver.Tab', 'safaridriver.message.Command', 'safaridriver.message.Load', 'safaridriver.message.Response', 'safaridriver.message.Unload']);
...
goog.addDependency("../../../javascript/safari-driver/inject/commands.js", ['safaridriver.inject.commands'], ['bot', 'bot.Error', 'bot.ErrorCode', 'bot.action', 'bot.dom', 'bot.frame', 'bot.inject', 'bot.inject.cache', 'bot.locators', 'bot.response', 'bot.window', 'goog.array', 'goog.debug.Logger', 'goog.math.Coordinate', 'goog.math.Size', 'goog.net.cookies', 'goog.style', 'safaridriver.inject.message.Activate', 'safaridriver.inject.state', 'webdriver.atoms.element', 'webdriver.promise.Deferred']);
goog.addDependency("../../../javascript/safari-driver/inject/inject.js", ['safaridriver.inject'], ['bot.ErrorCode', 'bot.locators.xpath', 'bot.response', 'goog.debug.Logger', 'safaridriver.Command', 'safaridriver.console', 'safaridriver.inject.commands', 'safaridriver.inject.message', 'safaridriver.inject.message.Activate', 'safaridriver.inject.message.ActivateFrame', 'safaridriver.inject.message.Encode', 'safaridriver.inject.message.ReactivateFrame', 'safaridriver.inject.page', 'safaridriver.inject.state', 'safaridriver.message', 'safaridriver.message.Command', 'safaridriver.message.Connect', 'safaridriver.message.Load', 'safaridriver.message.MessageTarget', 'safaridriver.message.Response', 'safaridriver.message.Unload', 'webdriver.Command', 'webdriver.CommandName', 'webdriver.promise']);
goog.addDependency("../../../javascript/safari-driver/inject/page.js", ['safaridriver.inject.page'], ['bot.Error', 'bot.ErrorCode', 'bot.dom', 'bot.inject', 'bot.locators.xpath', 'bot.response', 'goog.array', 'goog.debug.Logger', 'goog.dom', 'goog.object', 'goog.string', 'goog.dom.classes', 'safaridriver.console', 'safaridriver.inject.message.Encode', 'safaridriver.message', 'safaridriver.message.Command', 'safaridriver.message.Load', 'safaridriver.message.MessageTarget', 'safaridriver.message.Response', 'webdriver.CommandName', 'webdriver.promise']);
goog.addDependency("../../../javascript/safari-driver/inject/state.js", ['safaridriver.inject.state'], ['goog.asserts', 'goog.string']);
...
goog.addDependency("../../../javascript/safari-driver/message/load.js", ['safaridriver.message.BaseLoadMessage', 'safaridriver.message.Load', 'safaridriver.message.Unload'], ['safaridriver.message', 'safaridriver.message.Message']);
...
goog.addDependency("../../../javascript/webdriver/webdriver.js", ['webdriver.WebDriver', 'webdriver.WebDriver.Navigation', 'webdriver.WebDriver.Options', 'webdriver.WebDriver.TargetLocator', 'webdriver.WebDriver.Timeouts', 'webdriver.WebDriver.Window', 'webdriver.WebElement'], ['bot.Error', 'bot.ErrorCode', 'bot.response', 'goog.array', 'goog.object', 'webdriver.Command', 'webdriver.CommandName', 'webdriver.Key', 'webdriver.Locator', 'webdriver.Session', 'webdriver.promise', 'webdriver.promise.Application', 'webdriver.promise.Deferred', 'webdriver.promise.Promise']);
