...
goog.addDependency("../../../javascript/firefox-driver/extension/components/syntheticMouse.js", ['SyntheticMouse'], ['Utils', 'bot.ErrorCode', 'bot.Mouse', 'bot.action', 'bot.dom', 'bot.events', 'fxdriver.moz', 'fxdriver.utils', 'fxdriver.Logger', 'goog.math.Coordinate']);
...
goog.addDependency("../../../javascript/webdriver-jsapi/command.js", ['webdriver.Command', 'webdriver.CommandExecutor', 'webdriver.CommandName', 'webdriver.CommandResponse'], []);
...
goog.addDependency("../../../javascript/webdriver-jsapi/session.js", ['webdriver.Session'], []);
...
goog.addDependency("../../../javascript/webdriver-jsapi/webdriver.js", ['webdriver.Key', 'webdriver.WebDriver', 'webdriver.WebDriver.Navigation', 'webdriver.WebDriver.Options', 'webdriver.WebDriver.TargetLocator', 'webdriver.WebDriver.Timeouts', 'webdriver.WebElement'], ['bot.ErrorCode', 'goog.array', 'goog.object', 'webdriver.Command', 'webdriver.CommandName', 'webdriver.Locator', 'webdriver.Session', 'webdriver.error', 'webdriver.promise', 'webdriver.promise.Application', 'webdriver.promise.Deferred', 'webdriver.promise.Promise']);
...
goog.addDependency("../../../javascript/webdriver-jsapi/http/jsonpclient.js", ['webdriver.http.JsonpClient'], ['goog.dom', 'goog.json', 'webdriver.http.Response']);
goog.addDependency("../../../javascript/webdriver-jsapi/http/xhrclient.js", ['webdriver.http.XhrClient'], ['goog.json', 'webdriver.http.Response']);
