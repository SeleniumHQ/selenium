...
goog.addDependency("../../../javascript/webdriver-jsapi/testcase.js", ['webdriver.TestCase'], ['goog.array', 'goog.testing.TestCase', 'webdriver.asserts', 'webdriver.promise.Application']);
...
goog.addDependency("../../../javascript/webdriver-jsapi/http/http.js", ['webdriver.http.Client', 'webdriver.http.Executor', 'webdriver.http.Request', 'webdriver.http.Response'], ['bot.ErrorCode', 'goog.json', 'webdriver.CommandName', 'webdriver.promise.Deferred']);
...
goog.addDependency("../../../javascript/atoms/window.js", ['bot.window'], ['bot', 'bot.Error', 'bot.ErrorCode', 'goog.array', 'goog.dom', 'goog.math.Size', 'goog.math.Coordinate', 'goog.userAgent']);
...
goog.addDependency("../../../javascript/atoms/test/jquery-1.6.4.min.js", [], []);
...
goog.addDependency("../../../javascript/firefox-driver/extension/components/syntheticMouse.js", ['SyntheticMouse'], ['Utils', 'bot.ErrorCode', 'bot.Mouse', 'bot.action', 'bot.dom', 'bot.events', 'bot.window', 'fxdriver.moz', 'fxdriver.utils', 'fxdriver.Logger', 'goog.math.Coordinate']);
