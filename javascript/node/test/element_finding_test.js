...
describe('finding elements', function() {
  ...
  describe('By.id()', function() {
    ...
    test.ignore(browsers(Browser.ANDROID)).
    it('should find multiple elements by ID even though that\'s malformed HTML',
        function() {
  ...
  describe('By.linkText()', function() {
    ...
    test.it('matches by partial text when containing equals sign', function() {
      driver.get(Pages.xhtmlTestPage);
    ...
    test.it('works when searching for multiple with partial text containing =',
        function() {
          driver.get(Pages.xhtmlTestPage);
    ...
    test.it('should be able to find multiple exact matches',
        function() {
          driver.get(Pages.xhtmlTestPage);
          driver.findElements(By.linkText('click me')).then(function(elements) {
  ...
  describe('By.name()', function() {
    ...
    test.it('should be able to find elements that do not support name property',
        function() {
          driver.get(Pages.nestedPage);
  ...
  describe('By.tagName()', function() {
    test.it('works', function() {
      driver.get(Pages.formPage);
      driver.findElement(By.tagName('input')).getTagName().then(function(name) {
  ...
  describe('By.css()', function() {
    ...
    test.it(
        'should be able to find element with short boolean attribute selector',
        function() {
          driver.get(test.whereIs(
              'locators_tests/boolean_attribute_selected.html'));
          assertAttributeIs(
