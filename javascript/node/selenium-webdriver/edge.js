 ...
 * Microsoft's Edge web browser. Both Edge (Chromium), and Edge (EdgeHTML) are
 ...
 *         .build();
 * 
 * Note that Chromium-specific {@link Options} will be ignored when the legacy
 * EdgeHTML service is used.
 * 
