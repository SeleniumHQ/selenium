...
describe('net.splitHostAndPort', function () {
  it('hostname with no port', function () {
    assert.deepEqual(net.splitHostAndPort('www.example.com'), {
  ...
  it('hostname with port', function () {
    assert.deepEqual(net.splitHostAndPort('www.example.com:80'), {
      host: 'www.example.com',
      port: 80,
    })
  })
  ...
  it('IPv4 with no port', function () {
    assert.deepEqual(net.splitHostAndPort('127.0.0.1'), {
      host: '127.0.0.1',
      port: null,
    })
  })
  ...
  it('IPv4 with port', function () {
    assert.deepEqual(net.splitHostAndPort('127.0.0.1:1234'), {
      host: '127.0.0.1',
      port: 1234,
    })
  })
  ...
  it('IPv6 with no port', function () {
    assert.deepEqual(net.splitHostAndPort('1234:0:1000:5768:1234:5678:90'), {
