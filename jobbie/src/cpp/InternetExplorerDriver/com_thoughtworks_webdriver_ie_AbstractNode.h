...
#include <jni.h>
/* Header for class com_thoughtworks_webdriver_ie_AbstractNode */

#ifndef _Included_com_thoughtworks_webdriver_ie_AbstractNode
#define _Included_com_thoughtworks_webdriver_ie_AbstractNode
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_thoughtworks_webdriver_ie_AbstractNode
 * Method:    getDocument
