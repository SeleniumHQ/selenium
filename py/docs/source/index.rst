...
Alternately, you can download the source distribution from `PyPI <http://pypi.python.org/pypi/selenium>`_ (e.g. selenium-2.44.tar.gz), unarchive it, and run::
...
Download the server separately, from: http://selenium-release.storage.googleapis.com/2.44/selenium-server-standalone-2.44.jar

Run the server from the command line::

    java -jar selenium-server-standalone-2.44.jar
