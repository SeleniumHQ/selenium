...
class TestElementAttribute(object):

    def testShouldReturnNullWhenGettingTheValueOfAnAttributeThatIsNotListed(self, driver, pages):
        pages.load("simpleTest.html")
        head = driver.find_element_by_xpath("/html")
        attribute = head.get_attribute("cheese")
        assert attribute is None

    def testShouldReturnNullWhenGettingSrcAttributeOfInvalidImgTag(self, driver, pages):
        pages.load("simpleTest.html")
        img = driver.find_element_by_id("invalidImgTag")
        img_attr = img.get_attribute("src")
        assert img_attr is None

    def testShouldReturnAnAbsoluteUrlWhenGettingSrcAttributeOfAValidImgTag(self, driver, pages):
        pages.load("simpleTest.html")
        img = driver.find_element_by_id("validImgTag")
        img_attr = img.get_attribute("src")
        assert "icon.gif" in img_attr

    def testShouldReturnAnAbsoluteUrlWhenGettingHrefAttributeOfAValidAnchorTag(self, driver, pages):
        pages.load("simpleTest.html")
        img = driver.find_element_by_id("validAnchorTag")
        img_attr = img.get_attribute("href")
        assert "icon.gif" in img_attr

    def testShouldReturnEmptyAttributeValuesWhenPresentAndTheValueIsActuallyEmpty(self, driver, pages):
        pages.load("simpleTest.html")
        body = driver.find_element_by_xpath("//body")
        assert "" == body.get_attribute("style")

    def testShouldReturnTheValueOfTheDisabledAttributeAsFalseIfNotSet(self, driver, pages):
    ...
    def testShouldReturnTheValueOfTheIndexAttrbuteEvenIfItIsMissing(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testShouldIndicateTheElementsThatAreDisabledAreNotis_enabled(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testElementsShouldBeDisabledIfTheyAreDisabledUsingRandomDisabledStrings(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testShouldIndicateWhenATextAreaIsDisabled(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testShouldIndicateWhenASelectIsDisabled(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testShouldReturnTheValueOfCheckedForACheckboxEvenIfItLacksThatAttribute(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testShouldReturnTheValueOfSelectedForRadioButtonsEvenIfTheyLackThatAttribute(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testShouldReturnTheValueOfSelectedForOptionsInSelectsEvenIfTheyLackThatAttribute(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testShouldReturnValueOfClassAttributeOfAnElement(self, driver, pages):
    ...
    # def testShouldReturnValueOfClassAttributeOfAnElementAfterSwitchingIFrame(self, driver, pages):
    ...
    def testShouldReturnTheContentsOfATextAreaAsItsValue(self, driver, pages):
        pages.load("formPage.html")
        value = driver.find_element_by_id("withText").get_attribute("value")
        assert "Example text" == value

    def testShouldReturnTheContentsOfATextAreaAsItsValueWhenSetToNonNorminalTrue(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testShouldTreatReadonlyAsAValue(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testShouldGetNumericAtribute(self, driver, pages):
        pages.load("formPage.html")
        element = driver.find_element_by_id("withText")
        assert "5" == element.get_attribute("rows")

    def testCanReturnATextApproximationOfTheStyleAttribute(self, driver, pages):
        pages.load("javascriptPage.html")
        style = driver.find_element_by_id("red-item").get_attribute("style")
        assert "background-color" in style.lower()

    def testShouldCorrectlyReportValueOfColspan(self, driver, pages):
    ...
    def testCanRetrieveTheCurrentValueOfATextFormField_textInput(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testCanRetrieveTheCurrentValueOfATextFormField_emailInput(self, driver, pages):
        pages.load("formPage.html")
    ...
    def testCanRetrieveTheCurrentValueOfATextFormField_textArea(self, driver, pages):
        pages.load("formPage.html")
    ...
    def tesShouldGetUnicodeCharsFromAttribute(self, driver, pages):
        pages.load("formPage.html")
