...
class TestChildrenFinding(object):

    def test_should_find_element_by_xpath(self, driver, pages):
    ...
    def test_should_not_find_element_by_xpath(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("form2")
        with pytest.raises(NoSuchElementException):
            element.find_element_by_xpath("select/x")

    def test_finding_dot_slash_elements_on_element_by_xpath_should_find_not_top_level_elements(self, driver, pages):
    ...
    def test_should_find_elements_by_xpath(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("form2")
    ...
    def test_should_not_find_elements_by_xpath(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("form2")
        children = element.find_elements_by_xpath("select/x")
        assert len(children) == 0

    def test_finding_elements_on_element_by_xpath_should_find_top_level_elements(self, driver, pages):
        pages.load("simpleTest.html")
        parent = driver.find_element_by_id("multiline")
    ...
    def test_should_find_element_by_name(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("form2")
        child = element.find_element_by_name("selectomatic")
        assert child.get_attribute("id") == "2"

    def test_should_find_elements_by_name(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("form2")
        children = element.find_elements_by_name("selectomatic")
        assert len(children) == 2

    def test_should_find_element_by_id(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("form2")
        child = element.find_element_by_id("2")
        assert child.get_attribute("name") == "selectomatic"

    def test_should_find_elements_by_id(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("form2")
        child = element.find_elements_by_id("2")
        assert len(child) == 2

    def test_should_find_element_by_id_when_multiple_matches_exist(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_id("test_id_div")
        child = element.find_element_by_id("test_id")
        assert child.text == "inside"

    def test_should_find_element_by_id_when_no_match_in_context(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_id("test_id_div")
        with pytest.raises(NoSuchElementException):
            element.find_element_by_id("test_id_out")

    def test_should_find_element_by_link_text(self, driver, pages):
        pages.load("nestedElements.html")
    ...
    def test_should_find_elements_by_link_text(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("div1")
    ...
    def test_should_throw_an_error_if_user_passes_in_invalid_by(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("form2")
        with pytest.raises(WebDriverException):
            element.find_element("foo", "bar")

    def test_should_throw_an_error_if_user_passes_in_invalid_by_when_find_elements(self, driver, pages):
        pages.load("nestedElements.html")
        element = driver.find_element_by_name("form2")
        with pytest.raises(WebDriverException):
