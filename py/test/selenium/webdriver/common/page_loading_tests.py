...
# def_test_should_follow_redirects_sent_in_the_http_response_headers(driver, pages):
#    pages.load("redirect.html")
#    assert driver.title == "We Arrive Here"


# Disabled till the Java WebServer is used
# def_test_should_follow_meta_redirects(driver, pages):
#    pages.load("metaRedirect.html")
#    assert driver.title == "We Arrive Here"


# def_test_should_be_able_to_get_afragment_on_the_current_page(driver, pages):
...
# def_test_should_return_when_getting_aurl_that_does_not_resolve(driver):
...
# @pytest.mark.xfail_firefox(raises=WebDriverException)
# @pytest.mark.xfail_remote(raises=WebDriverException)
# def_test_should_return_when_getting_aurl_that_does_not_connect(driver):
#     #  Here's hoping that there's nothing here. There shouldn't be
#     driver.get("http://localhost:3001")

# def_test_should_be_able_to_load_apage_with_framesets_and_wait_until_all_frames_are_loaded() {
...
# @NeedsFreshDriver
# def_test_sould_do_nothing_if_there_is_nothing_to_go_back_to() {
...
# def_test_should_be_able_to_navigate_back_in_the_browser_history(driver, pages):
...
# @pytest.mark.xfail_safari
# def_test_should_be_able_to_navigate_back_in_the_browser_history_in_presence_of_iframes(driver, pages):
#     pages.load("xhtmlTest.html")
...
# def_test_should_be_able_to_navigate_forwards_in_the_browser_history(driver, pages):
#     pages.load("formPage.html")
...
# def_test_should_not_hangif_document_open_call_is_never_followed_by_document_close_call(driver, pages):
