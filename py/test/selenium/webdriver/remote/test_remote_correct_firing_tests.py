...
def setup_module(module):
    ...
    try:
        ...
        RemoteCorrectEventFiringTests.server_proc = subprocess.Popen(
    ...
    RemoteCorrectEventFiringTests.driver = webdriver.connect("remote", browser_name="firefox", platform="ANY")
...
def teardown_module(module):
    ...
    try:
        os.kill(RemoteCorrectEventFiringTests.server_proc.pid, signal.SIGTERM)
        time.sleep(5)
    except:
        pass
