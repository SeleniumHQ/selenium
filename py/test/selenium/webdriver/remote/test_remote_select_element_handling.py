...
def setup_module(module):
    ...
    try:
        ...
        RemoteSelectElementHandlingTests.server_proc = subprocess.Popen(
    ...
    RemoteSelectElementHandlingTests.driver = webdriver.connect("remote", browser_name="firefox", platform="ANY")
...
def teardown_module(module):
    try:
        RemoteSelectElementHandlingTests.driver.quit()
    except AttributeError:
        pass
    try:
        RemoteSelectElementHandlingTests.webserver.stop()
    except AttributeError:
        pass    
    # FIXME: This does not seem to work, the server process lingers
    try:
        os.kill(RemoteSelectElementHandlingTests.server_proc.pid, signal.SIGTERM)
        time.sleep(5)
    except:
        pass
