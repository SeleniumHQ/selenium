...
def setup_module(module):
    ...
    try:
        ...
        RemoteFormHandlingTests.server_proc = subprocess.Popen(
    ...
    RemoteFormHandlingTests.driver = webdriver.connect("remote", browser_name="firefox", platform="ANY")
...
def teardown_module(module):
    try:
        RemoteFormHandlingTests.driver.quit()
    except AttributeError:
        pass
    try:
        RemoteFormHandlingTests.webserver.stop()
    except AttributeError:
        pass    
    try:
        os.kill(RemoteFormHandlingTests.server_proc.pid, signal.SIGTERM)
        time.sleep(5)
    except:
        pass
