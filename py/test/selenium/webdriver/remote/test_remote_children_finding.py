...
from selenium.test.selenium.webdriver.common import children_finding_tests 
...
def setup_module(module):
    ...
    try:
        ...
        RemoteChildrenFindingTests.server_proc = subprocess.Popen(
    ...
    RemoteChildrenFindingTests.driver = webdriver.Remote(desired_capabilities = webdriver.DesiredCapabilities.FIREFOX)
...
def teardown_module(module):
    try:
        RemoteChildrenFindingTests.driver.quit()
    except AttributeError:
        pass
    try:
        RemoteChildrenFindingTests.webserver.stop()
    except AttributeError:
        pass    
    # FIXME: This does not seem to work, the server process lingers
    try:
        os.kill(RemoteChildrenFindingTests.server_proc.pid, signal.SIGTERM)
        time.sleep(5)
    except:
        pass
