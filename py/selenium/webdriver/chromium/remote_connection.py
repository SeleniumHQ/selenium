...
class ChromiumRemoteConnection(RemoteConnection):
    def __init__(
        ...
        RemoteConnection.__init__(
            self, remote_server_addr, keep_alive, ignore_proxy=ignore_proxy
        )
        ...
        self._commands["executeCdpCommand"] = (
            "POST",
            "/session/$sessionId/{}/cdp/execute".format(vendor_prefix),
        )
        ...
        self._commands["getIssueMessage"] = (
            "GET",
            "/session/$sessionId/{}/cast/get_issue_message".format(vendor_prefix),
        )
        ...
        self._commands["startDesktopMirroring"] = (
            "POST",
            "/session/$sessionId/{}/cast/start_desktop_mirroring".format(vendor_prefix),
        )
        self._commands["startTabMirroring"] = (
            "POST",
            "/session/$sessionId/{}/cast/start_tab_mirroring".format(vendor_prefix),
        )
