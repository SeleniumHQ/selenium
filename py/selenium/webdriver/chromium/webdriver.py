...
from .remote_connection import ChromiumRemoteConnection
...
class WebDriver(RemoteWebDriver):
    """
    Controls the WebDriver and allows you to drive the browser.
    """
    ...
    def __init__(self, executable_path=None, port=DEFAULT_PORT,
        ...
        Starts the service and then creates new instance of webdriver.
    ...
    def execute_cdp_cmd(self, cmd, cmd_args):
        """
        Execute Chromium Devtools Protocol command and get returned result
    ...
    def quit(self):
        ...
        that is started when starting the WebDriver
        """
        try:
