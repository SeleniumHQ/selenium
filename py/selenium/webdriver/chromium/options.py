...
class ChromiumOptions(ArgOptions):
    ...
    def debugger_address(self, value):
        ...
        that the WebDriver instance will try to connect to during an
        active wait.
    ...
    def extensions(self):
        """
        :Returns: A list of encoded extensions that will be loaded into chromium
        """
        encoded_extensions = []
    ...
    def to_capabilities(self):
        ...
        """
        caps = self._caps
        chromium_options = self.experimental_options.copy()
        chromium_options["extensions"] = self.extensions
        if self.binary_location:
            chromium_options["binary"] = self.binary_location
        chromium_options["args"] = self.arguments
        if self.debugger_address:
            chromium_options["debuggerAddress"] = self.debugger_address

        caps[self.KEY] = chromium_options
