...
`,Rt=Et,fe={CONTAINS:"contains",ARROW:"arrow"},mt=(e,t)=>{let a=e.append("defs").append("marker").attr("id",fe.CONTAINS+"_line_ending").attr("refX",0).attr("refY",t.line_height/2).attr("markerWidth",t.line_height).attr("markerHeight",t.line_height).attr("orient","auto").append("g");a.append("circle").attr("cx",t.line_height/2).attr("cy",t.line_height/2).attr("r",t.line_height/2).attr("fill","none"),a.append("line").attr("x1",0).attr("x2",t.line_height).attr("y1",t.line_height/2).attr("y2",t.line_height/2).attr("stroke-width",1),a.append("line").attr("y1",0).attr("y2",t.line_height).attr("x1",t.line_height/2).attr("x2",t.line_height/2).attr("stroke-width",1),e.append("defs").append("marker").attr("id",fe.ARROW+"_line_ending").attr("refX",t.line_height).attr("refY",.5*t.line_height).attr("markerWidth",t.line_height).attr("markerHeight",t.line_height).attr("orient","auto").append("path").attr("d",`M0,0
      ...
      L0,${t.line_height}`).attr("stroke-width",1)},Pe={ReqMarkers:fe,insertLineEndings:mt},y={},Me=0,Ye=(e,t)=>e.insert("rect","#"+t).attr("class","req reqBox").attr("x",0).attr("y",0).attr("width",y.rect_min_width+"px").attr("height",y.rect_min_height+"px"),Ue=(e,t,a)=>{let o=y.rect_min_width/2,d=e.append("text").attr("class","req reqLabel reqTitle").attr("id",t).attr("x",o).attr("y",y.rect_padding).attr("dominant-baseline","hanging"),u=0;a.forEach(g=>{u==0?d.append("tspan").attr("text-anchor","middle").attr("x",y.rect_min_width/2).attr("dy",0).text(g):d.append("tspan").attr("text-anchor","middle").attr("x",y.rect_min_width/2).attr("dy",y.line_height*.75).text(g),u++});let p=1.5*y.rect_padding,h=u*y.line_height*.75,c=p+h;return e.append("line").attr("class","req-title-line").attr("x1","0").attr("x2",y.rect_min_width).attr("y1",c).attr("y2",c),{titleNode:d,y:c}},Be=(e,t,a,o)=>{let d=e.append("text").attr("class","req reqLabel").attr("id",t).attr("x",y.rect_padding).attr("y",o).attr("dominant-baseline","hanging"),u=0,p=30,h=[];return a.forEach(c=>{let g=c.length;for(;g>p&&u<3;){let R=c.substring(0,p);c=c.substring(p,c.length),g=c.length,h[h.length]=R,u++}if(u==3){let R=h[h.length-1];h[h.length-1]=R.substring(0,R.length-4)+"..."}else h[h.length]=c;u=0}),h.forEach(c=>{d.append("tspan").attr("x",y.rect_padding).attr("dy",y.line_height).text(c)}),d},It=(e,t,a,o)=>{let d=t.node().getTotalLength(),u=t.node().getPointAtLength(d*.5),p="rel"+Me;Me++;let c=e.append("text").attr("class","req relationshipLabel").attr("id",p).attr("x",u.x).attr("y",u.y).attr("text-anchor","middle").attr("dominant-baseline","middle").text(o).node().getBBox();e.insert("rect","#"+p).attr("class","req reqLabelBox").attr("x",u.x-c.width/2).attr("y",u.y-c.height/2).attr("width",c.width).attr("height",c.height).attr("fill","white").attr("fill-opacity","85%")},bt=function(e,t,a,o,d){let u=a.edge(W(t.src),W(t.dst)),p=Ae().x(function(c){return c.x}).y(function(c){return c.y}),h=e.insert("path","#"+o).attr("class","er relationshipLine").attr("d",p(u.points)).attr("fill","none");t.type==d.db.Relationships.CONTAINS?h.attr("marker-start","url("+de.getUrl(y.arrowMarkerAbsolute)+"#"+t.type+"_line_ending)"):(h.attr("stroke-dasharray","10,7"),h.attr("marker-end","url("+de.getUrl(y.arrowMarkerAbsolute)+"#"+Pe.ReqMarkers.ARROW+"_line_ending)")),It(e,h,y,`<<${t.type}>>`)},kt=(e,t,a)=>{Object.keys(e).forEach(o=>{let d=e[o];o=W(o),ue.info("Added new requirement: ",o);let u=a.append("g").attr("id",o),p="req-"+o,h=Ye(u,p),c=Ue(u,o+"_title",[`<<${d.type}>>`,`${d.name}`]);Be(u,o+"_body",[`Id: ${d.id}`,`Text: ${d.text}`,`Risk: ${d.risk}`,`Verification: ${d.verifyMethod}`],c.y);let g=h.node().getBBox();t.setNode(o,{width:g.width,height:g.height,shape:"rect",id:o})})},St=(e,t,a)=>{Object.keys(e).forEach(o=>{let d=e[o],u=W(o),p=a.append("g").attr("id",u),h="element-"+u,c=Ye(p,h),g=Ue(p,h+"_title",["<<Element>>",`${o}`]);Be(p,h+"_body",[`Type: ${d.type||"Not Specified"}`,`Doc Ref: ${d.docRef||"None"}`],g.y);let R=c.node().getBBox();t.setNode(u,{width:R.width,height:R.height,shape:"rect",id:u})})},Tt=(e,t)=>(e.forEach(function(a){let o=W(a.src),d=W(a.dst);t.setEdge(o,d,{relationship:a})}),e),Nt=function(e,t){t.nodes().forEach(function(a){a!==void 0&&t.node(a)!==void 0&&(e.select("#"+a),e.select("#"+a).attr("transform","translate("+(t.node(a).x-t.node(a).width/2)+","+(t.node(a).y-t.node(a).height/2)+" )"))})},W=e=>e.replace(/\s/g,"").replace(/\./g,"_"),vt=(e,t,a,o)=>{y=pe().requirement;let d=y.securityLevel,u;d==="sandbox"&&(u=re("#i"+t));let h=(d==="sandbox"?re(u.nodes()[0].contentDocument.body):re("body")).select(`[id='${t}']`);Pe.insertLineEndings(h,y);let c=new we({multigraph:!1,compound:!1,directed:!0}).setGraph({rankdir:y.layoutDirection,marginx:20,marginy:20,nodesep:100,edgesep:100,ranksep:100}).setDefaultEdgeLabel(function(){return{}}),g=o.db.getRequirements(),R=o.db.getElements(),v=o.db.getRelationships();kt(g,c,h),St(R,c,h),Tt(v,c),Ve(c),Nt(h,c),v.forEach(function(N){bt(h,N,c,t,o)});let S=y.rect_padding,T=h.node().getBBox(),x=T.width+S*2,A=T.height+S*2;$e(h,A,x,y.useMaxWidth),h.attr("viewBox",`${T.x-S} ${T.y-S} ${x} ${A}`)},xt={draw:vt},Dt={parser:Je,db:gt,renderer:xt,styles:Rt};export{Dt as diagram};
//# sourceMappingURL=requirementDiagram-e13af0f0-JISW5VYB.min.js.map
