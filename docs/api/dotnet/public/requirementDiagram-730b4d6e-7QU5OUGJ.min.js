...
`,Et=gt,_e={CONTAINS:"contains",ARROW:"arrow"},Rt=(e,t)=>{let a=e.append("defs").append("marker").attr("id",_e.CONTAINS+"_line_ending").attr("refX",0).attr("refY",t.line_height/2).attr("markerWidth",t.line_height).attr("markerHeight",t.line_height).attr("orient","auto").append("g");a.append("circle").attr("cx",t.line_height/2).attr("cy",t.line_height/2).attr("r",t.line_height/2).attr("fill","none"),a.append("line").attr("x1",0).attr("x2",t.line_height).attr("y1",t.line_height/2).attr("y2",t.line_height/2).attr("stroke-width",1),a.append("line").attr("y1",0).attr("y2",t.line_height).attr("x1",t.line_height/2).attr("x2",t.line_height/2).attr("stroke-width",1),e.append("defs").append("marker").attr("id",_e.ARROW+"_line_ending").attr("refX",t.line_height).attr("refY",.5*t.line_height).attr("markerWidth",t.line_height).attr("markerHeight",t.line_height).attr("orient","auto").append("path").attr("d",`M0,0
      L${t.line_height},${t.line_height/2}
      M${t.line_height},${t.line_height/2}
      L0,${t.line_height}`).attr("stroke-width",1)},Pe={ReqMarkers:_e,insertLineEndings:Rt},y={},Me=0,Ye=(e,t)=>e.insert("rect","#"+t).attr("class","req reqBox").attr("x",0).attr("y",0).attr("width",y.rect_min_width+"px").attr("height",y.rect_min_height+"px"),Ue=(e,t,a)=>{let c=y.rect_min_width/2,d=e.append("text").attr("class","req reqLabel reqTitle").attr("id",t).attr("x",c).attr("y",y.rect_padding).attr("dominant-baseline","hanging"),u=0;a.forEach(g=>{u==0?d.append("tspan").attr("text-anchor","middle").attr("x",y.rect_min_width/2).attr("dy",0).text(g):d.append("tspan").attr("text-anchor","middle").attr("x",y.rect_min_width/2).attr("dy",y.line_height*.75).text(g),u++});let p=1.5*y.rect_padding,h=u*y.line_height*.75,o=p+h;return e.append("line").attr("class","req-title-line").attr("x1","0").attr("x2",y.rect_min_width).attr("y1",o).attr("y2",o),{titleNode:d,y:o}},Be=(e,t,a,c)=>{let d=e.append("text").attr("class","req reqLabel").attr("id",t).attr("x",y.rect_padding).attr("y",c).attr("dominant-baseline","hanging"),u=0,p=30,h=[];return a.forEach(o=>{let g=o.length;for(;g>p&&u<3;){let R=o.substring(0,p);o=o.substring(p,o.length),g=o.length,h[h.length]=R,u++}if(u==3){let R=h[h.length-1];h[h.length-1]=R.substring(0,R.length-4)+"..."}else h[h.length]=o;u=0}),h.forEach(o=>{d.append("tspan").attr("x",y.rect_padding).attr("dy",y.line_height).text(o)}),d},mt=(e,t,a,c)=>{let d=t.node().getTotalLength(),u=t.node().getPointAtLength(d*.5),p="rel"+Me;Me++;let o=e.append("text").attr("class","req relationshipLabel").attr("id",p).attr("x",u.x).attr("y",u.y).attr("text-anchor","middle").attr("dominant-baseline","middle").text(c).node().getBBox();e.insert("rect","#"+p).attr("class","req reqLabelBox").attr("x",u.x-o.width/2).attr("y",u.y-o.height/2).attr("width",o.width).attr("height",o.height).attr("fill","white").attr("fill-opacity","85%")},It=function(e,t,a,c,d){let u=a.edge(W(t.src),W(t.dst)),p=Ae().x(function(o){return o.x}).y(function(o){return o.y}),h=e.insert("path","#"+c).attr("class","er relationshipLine").attr("d",p(u.points)).attr("fill","none");t.type==d.db.Relationships.CONTAINS?h.attr("marker-start","url("+ue.getUrl(y.arrowMarkerAbsolute)+"#"+t.type+"_line_ending)"):(h.attr("stroke-dasharray","10,7"),h.attr("marker-end","url("+ue.getUrl(y.arrowMarkerAbsolute)+"#"+Pe.ReqMarkers.ARROW+"_line_ending)")),mt(e,h,y,`<<${t.type}>>`)},bt=(e,t,a)=>{Object.keys(e).forEach(c=>{let d=e[c];c=W(c),he.info("Added new requirement: ",c);let u=a.append("g").attr("id",c),p="req-"+c,h=Ye(u,p),o=Ue(u,c+"_title",[`<<${d.type}>>`,`${d.name}`]);Be(u,c+"_body",[`Id: ${d.id}`,`Text: ${d.text}`,`Risk: ${d.risk}`,`Verification: ${d.verifyMethod}`],o.y);let g=h.node().getBBox();t.setNode(c,{width:g.width,height:g.height,shape:"rect",id:c})})},kt=(e,t,a)=>{Object.keys(e).forEach(c=>{let d=e[c],u=W(c),p=a.append("g").attr("id",u),h="element-"+u,o=Ye(p,h),g=Ue(p,h+"_title",["<<Element>>",`${c}`]);Be(p,h+"_body",[`Type: ${d.type||"Not Specified"}`,`Doc Ref: ${d.docRef||"None"}`],g.y);let R=o.node().getBBox();t.setNode(u,{width:R.width,height:R.height,shape:"rect",id:u})})},St=(e,t)=>(e.forEach(function(a){let c=W(a.src),d=W(a.dst);t.setEdge(c,d,{relationship:a})}),e),Tt=function(e,t){t.nodes().forEach(function(a){a!==void 0&&t.node(a)!==void 0&&(e.select("#"+a),e.select("#"+a).attr("transform","translate("+(t.node(a).x-t.node(a).width/2)+","+(t.node(a).y-t.node(a).height/2)+" )"))})},W=e=>e.replace(/\s/g,"").replace(/\./g,"_"),Nt=(e,t,a,c)=>{y=de().requirement,c.db.clear(),c.parser.parse(e);let d=y.securityLevel,u;d==="sandbox"&&(u=re("#i"+t));let h=(d==="sandbox"?re(u.nodes()[0].contentDocument.body):re("body")).select(`[id='${t}']`);Pe.insertLineEndings(h,y);let o=new we({multigraph:!1,compound:!1,directed:!0}).setGraph({rankdir:y.layoutDirection,marginx:20,marginy:20,nodesep:100,edgesep:100,ranksep:100}).setDefaultEdgeLabel(function(){return{}}),g=c.db.getRequirements(),R=c.db.getElements(),v=c.db.getRelationships();bt(g,o,h),kt(R,o,h),St(v,o),Ve(o),Tt(h,o),v.forEach(function(N){It(h,N,o,t,c)});let S=y.rect_padding,T=h.node().getBBox(),x=T.width+S*2,A=T.height+S*2;$e(h,A,x,y.useMaxWidth),h.attr("viewBox",`${T.x-S} ${T.y-S} ${x} ${A}`)},vt={draw:Nt},Ct={parser:Xe,db:yt,renderer:vt,styles:Et};export{Ct as diagram};
//# sourceMappingURL=requirementDiagram-730b4d6e-7QU5OUGJ.min.js.map
