...
const char* const EXECUTE_ASYNC_SCRIPT =
    ...
    "\"}function s(a){return typeof a==\"string\"}function u(a){return a[ba]||"
    ...
    "shift.apply(c,b);return a.apply(this,c)}}var v=Date.now||function(){retur"
    "n+new Date};\nfunction w(a,b){function c(){}c.prototype=b.prototype;a.v=b"
    ".prototype;a.prototype=new c};function x(a){this.stack=Error().stack||\""
    "\";if(a)this.message=String(a)}w(x,Error);x.prototype.name=\"CustomError"
    "\";function ea(a,b,c){var d={};for(var g in a)if(b.call(c,a[g],g,a))d[g]="
    "a[g];return d}function fa(a,b,c){var d={};for(var g in a)d[g]=b.call(c,a["
    "g],g,a);return d}function ga(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))"
    "return d};var y=0;function z(a,b){x.call(this,b);this.code=a;this.name=A["
    "a]||A[13]}w(z,x);var A,ha={NoSuchElementError:7,NoSuchFrameError:8,Unknow"
    ...
    "riptTimeoutError:28},ia={};for(var ja in ha)ia[ha[ja]]=ja;A=ia;\nz.protot"
    "ype.toString=function(){return\"[\"+this.name+\"] \"+this.message};functi"
    "on ka(a){for(var b=1;b<arguments.length;b++){var c=String(arguments[b]).r"
    "eplace(/\\$/g,\"$$$$\");a=a.replace(/\\%s/,c)}return a}\nfunction la(a,b)"
    "{var c=0,d=String(a).replace(/^[\\s\\xa0]+|[\\s\\xa0]+$/g,\"\").split(\"."
    "\"),g=String(b).replace(/^[\\s\\xa0]+|[\\s\\xa0]+$/g,\"\").split(\".\"),e"
    "=Math.max(d.length,g.length);for(var f=0;c==0&&f<e;f++){var h=d[f]||\"\","
    "k=g[f]||\"\",l=RegExp(\"(\\\\d*)(\\\\D*)\",\"g\"),r=RegExp(\"(\\\\d*)("
    "\\\\D*)\",\"g\");do{var m=l.exec(h)||[\"\",\"\",\"\"],i=r.exec(k)||[\"\","
    ...
    "all(this,ka.apply(null,b));b.shift();this.C=a}w(E,x);E.prototype.name=\"A"
    "ssertionError\";function F(a,b){if(!a){var c=Array.prototype.slice.call(a"
    "rguments,2),d=\"Assertion failed\";if(b){d+=\": \"+b;var g=c}throw new E("
    "\"\"+d,g||[]);}return a};var G=Array.prototype,ma=G.indexOf?function(a,b,"
    "c){F(a.length!=null);return G.indexOf.call(a,b,c)}:function(a,b,c){c=c==n"
    "ull?0:c<0?Math.max(0,a.length+c):c;if(s(a)){if(!s(b)||b.length!=1)return-"
    "1;return a.indexOf(b,c)}for(c=c;c<a.length;c++)if(c in a&&a[c]===b)return"
    " c;return-1},na=G.map?function(a,b,c){F(a.length!=null);return G.map.call"
    "(a,b,c)}:function(a,b,c){var d=a.length,g=Array(d),e=s(a)?a.split(\"\"):a"
    ";for(var f=0;f<d;f++)if(f in e)g[f]=b.call(c,e[f],f,a);return g};var oa=o"
    ".navigator,pa=(oa&&oa.platform||\"\").indexOf(\"Mac\")!=-1,qa=\"\",ra;if("
    "ra=/WebKit\\/(\\S+)/){var sa=ra.exec(o.navigator?o.navigator.userAgent:nu"
    "ll);qa=sa?sa[1]:\"\"};var ta=[];var H;function I(){if(ua)J[u(this)]=this}"
    "var ua=false,J={};I.prototype.o=false;I.prototype.g=function(){if(!this.o"
    "){this.o=true;this.d();if(ua){var a=u(this);if(!J.hasOwnProperty(a))throw"
    " Error(this+\" did not call the goog.Disposable base constructor or was d"
    "isposed of after a clearUndisposedObjects call\");delete J[a]}}};I.protot"
    "ype.d=function(){};function K(a,b){I.call(this);this.type=a;this.currentT"
    "arget=this.target=b}w(K,I);K.prototype.d=function(){delete this.type;dele"
    "te this.target;delete this.currentTarget};K.prototype.l=false;K.prototype"
    ".A=true;new Function(\"a\",\"return a\");function L(a,b){a&&this.h(a,b)}w"
    "(L,K);j=L.prototype;j.target=null;j.relatedTarget=null;j.offsetX=0;j.offs"
    "etY=0;j.clientX=0;j.clientY=0;j.screenX=0;j.screenY=0;j.button=0;j.keyCod"
    "e=0;j.charCode=0;j.ctrlKey=false;j.altKey=false;j.shiftKey=false;j.metaKe"
    "y=false;j.z=false;j.p=null;\nj.h=function(a,b){var c=this.type=a.type;K.c"
    "all(this,c);this.target=a.target||a.srcElement;this.currentTarget=b;var d"
    "=a.relatedTarget;if(!d)if(c==\"mouseover\")d=a.fromElement;else if(c==\"m"
    "ouseout\")d=a.toElement;this.relatedTarget=d;this.offsetX=a.offsetX!==und"
    "efined?a.offsetX:a.layerX;this.offsetY=a.offsetY!==undefined?a.offsetY:a."
    "layerY;this.clientX=a.clientX!==undefined?a.clientX:a.pageX;this.clientY="
    "a.clientY!==undefined?a.clientY:a.pageY;this.screenX=a.screenX||0;this.sc"
    "reenY=a.screenY||0;this.button=\na.button;this.keyCode=a.keyCode||0;this."
    "charCode=a.charCode||(c==\"keypress\"?a.keyCode:0);this.ctrlKey=a.ctrlKey"
    ";this.altKey=a.altKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;thi"
    "s.z=pa?a.metaKey:a.ctrlKey;this.B=a.B;this.p=a;delete this.A;delete this."
    "l};j.d=function(){L.v.d.call(this);this.relatedTarget=this.currentTarget="
    "this.target=this.p=null};function va(){}var wa=0;j=va.prototype;j.key=0;j"
    ".f=false;j.m=false;j.h=function(a,b,c,d,g,e){if(q(a)==\"function\")this.r"
    "=true;else if(a&&a.handleEvent&&q(a.handleEvent)==\"function\")this.r=fal"
    "se;else throw Error(\"Invalid listener argument\");this.i=a;this.u=b;this"
    ".src=c;this.type=d;this.capture=!!g;this.q=e;this.m=false;this.key=++wa;t"
    "his.f=false};j.handleEvent=function(a){if(this.r)return this.i.call(this."
    "q||this.src,a);return this.i.handleEvent.call(this.i,a)};function M(a,b){"
    "I.call(this);this.s=b;this.c=[];if(a>this.s)throw Error(\"[goog.structs.S"
    "implePool] Initial cannot be greater than max\");for(var c=0;c<a;c++)this"
    ".c.push(this.a?this.a():{})}w(M,I);M.prototype.a=null;M.prototype.n=null;"
    "function N(a){if(a.c.length)return a.c.pop();return a.a?a.a():{}}function"
    " O(a,b){a.c.length<a.s?a.c.push(b):xa(a,b)}function xa(a,b){if(a.n)a.n(b)"
    ";else{var c=q(b);if(c==\"object\"||c==\"array\"||c==\"function\")if(q(b.g"
    ")==\"function\")b.g();else for(var d in b)delete b[d]}}\nM.prototype.d=fu"
    "nction(){M.v.d.call(this);for(var a=this.c;a.length;)xa(this,a.pop());del"
    "ete this.c};var ya;var za=(ya=\"ScriptEngine\"in o&&o.ScriptEngine()==\"J"
    "Script\")?o.ScriptEngineMajorVersion()+\".\"+o.ScriptEngineMinorVersion()"
    "+\".\"+o.ScriptEngineBuildVersion():\"0\";var P,Q,R,S,Aa,Ba,Ca,Da,Ea,Fa,G"
    "a;\n(function(){function a(){return{b:0,e:0}}function b(){return[]}functi"
    "on c(){function i(n){return f.call(i.src,i.key,n)}return i}function d(){r"
    "eturn new va}function g(){return new L}var e=ya&&!(la(za,\"5.7\")>=0),f;B"
    "a=function(i){f=i};if(e){P=function(){return N(h)};Q=function(i){O(h,i)};"
    "R=function(){return N(k)};S=function(i){O(k,i)};Aa=function(){return N(l)"
    "};Ca=function(){O(l,c())};Da=function(){return N(r)};Ea=function(i){O(r,i"
    ")};Fa=function(){return N(m)};Ga=function(i){O(m,i)};var h=new M(0,600);"
    "\nh.a=a;var k=new M(0,600);k.a=b;var l=new M(0,600);l.a=c;var r=new M(0,6"
    "00);r.a=d;var m=new M(0,600);m.a=g}else{P=a;Q=p;R=b;S=p;Aa=c;Ca=p;Da=d;Ea"
    "=p;Fa=g;Ga=p}})();var T={},U={},V={},Ha={};\nfunction Ia(a,b,c,d,g){if(b)"
    "if(q(b)==\"array\"){for(var e=0;e<b.length;e++)Ia(a,b[e],c,d,g);return nu"
    "ll}else{d=!!d;var f=U;b in f||(f[b]=P());f=f[b];if(!(d in f)){f[d]=P();f."
    "b++}f=f[d];var h=u(a),k;f.e++;if(f[h]){k=f[h];for(e=0;e<k.length;e++){f=k"
    "[e];if(f.i==c&&f.q==g){if(f.f)break;return k[e].key}}}else{k=f[h]=R();f.b"
    "++}e=Aa();e.src=a;f=Da();f.h(c,e,a,b,d,g);c=f.key;e.key=c;k.push(f);T[c]="
    "f;V[h]||(V[h]=R());V[h].push(f);if(a.addEventListener){if(a==o||!a.w)a.ad"
    "dEventListener(b,e,d)}else a.attachEvent(Ja(b),\ne);return c}else throw E"
    "rror(\"Invalid event type\");}function Ka(a){if(!T[a])return false;var b="
    "T[a];if(b.f)return false;var c=b.src,d=b.type,g=b.u,e=b.capture;if(c.remo"
    "veEventListener){if(c==o||!c.w)c.removeEventListener(d,g,e)}else c.detach"
    "Event&&c.detachEvent(Ja(d),g);c=u(c);g=U[d][e][c];if(V[c]){var f=V[c],h=m"
    "a(f,b);if(h>=0){F(f.length!=null);G.splice.call(f,h,1)}f.length==0&&delet"
    "e V[c]}b.f=true;g.t=true;La(d,e,c,g);delete T[a];return true}\nfunction L"
    "a(a,b,c,d){if(!d.j)if(d.t){var g=0;for(var e=0;g<d.length;g++)if(d[g].f){"
    "var f=d[g].u;f.src=null;Ca(f);Ea(d[g])}else{if(g!=e)d[e]=d[g];e++}d.lengt"
    "h=e;d.t=false;if(e==0){S(d);delete U[a][b][c];U[a][b].b--;if(U[a][b].b==0"
    "){Q(U[a][b]);delete U[a][b];U[a].b--}if(U[a].b==0){Q(U[a]);delete U[a]}}}"
    "}function Ja(a){if(a in Ha)return Ha[a];return Ha[a]=\"on\"+a}\nfunction "
    "Ma(a,b,c,d,g){var e=1;b=u(b);if(a[b]){a.e--;a=a[b];if(a.j)a.j++;else a.j="
    "1;try{var f=a.length;for(var h=0;h<f;h++){var k=a[h];if(k&&!k.f)e&=Na(k,g"
    ")!==false}}finally{a.j--;La(c,d,b,a)}}return Boolean(e)}function Na(a,b){"
    "var c=a.handleEvent(b);a.m&&Ka(a.key);return c}\nfunction W(a,b){if(!T[a]"
    ")return true;var c=T[a],d=c.type,g=U;if(!(d in g))return true;g=g[d];var "
    "e,f;if(H===undefined)H=false;if(H){var h;if(!(h=b))a:{h=\"window.event\"."
    "split(\".\");var k=o;for(;e=h.shift();)if(k[e]!=null)k=k[e];else{h=null;b"
    "reak a}h=k}e=h;h=true in g;k=false in g;if(h){if(e.keyCode<0||e.returnVal"
    "ue!=undefined)return true;a:{var l=false;if(e.keyCode==0)try{e.keyCode=-1"
    ";break a}catch(r){l=true}if(l||e.returnValue==undefined)e.returnValue=tru"
    "e}}l=Fa();l.h(e,this);e=true;try{if(h){var m=\nR();for(var i=l.currentTar"
    "get;i;i=i.parentNode)m.push(i);f=g[true];f.e=f.b;for(var n=m.length-1;!l."
    "l&&n>=0&&f.e;n--){l.currentTarget=m[n];e&=Ma(f,m[n],d,true,l)}if(k){f=g[f"
    "alse];f.e=f.b;for(n=0;!l.l&&n<m.length&&f.e;n++){l.currentTarget=m[n];e&="
    "Ma(f,m[n],d,false,l)}}}else e=Na(c,l)}finally{if(m){m.length=0;S(m)}l.g()"
    ";Ga(l)}return e}d=new L(b,this);try{e=Na(c,d)}finally{d.g()}return e}Ba(W"
    ");ta[ta.length]=function(a){W=a(W);Ba(W)};function Oa(){}\nfunction Pa(a,"
    "b,c){switch(typeof b){case \"string\":Qa(a,b,c);break;case \"number\":c.p"
    "ush(isFinite(b)&&!isNaN(b)?b:\"null\");break;case \"boolean\":c.push(b);b"
    "reak;case \"undefined\":c.push(\"null\");break;case \"object\":if(b==null"
    "){c.push(\"null\");break}if(q(b)==\"array\"){var d=b.length;c.push(\"[\")"
    ";var g=\"\";for(var e=0;e<d;e++){c.push(g);Pa(a,b[e],c);g=\",\"}c.push(\""
    "]\");break}c.push(\"{\");d=\"\";for(g in b)if(Object.prototype.hasOwnProp"
    "erty.call(b,g)){e=b[g];if(typeof e!=\"function\"){c.push(d);Qa(a,g,c);c.p"
    "ush(\":\");\nPa(a,e,c);d=\",\"}}c.push(\"}\");break;case \"function\":bre"
    "ak;default:throw Error(\"Unknown type: \"+typeof b);}}var Ra={'\"':'"
    "\\\\\"',\"\\\\\":\"\\\\\\\\\",\"/\":\"\\\\/\",\"\\u0008\":\"\\\\b\",\"\\u"
    "000c\":\"\\\\f\",\"\\n\":\"\\\\n\",\"\\r\":\"\\\\r\",\"\\t\":\"\\\\t\",\""
    "\\u000b\":\"\\\\u000b\"},Sa=/\\uffff/.test(\"\\uffff\")?/[\\\\\\\"\\x00-"
    "\\x1f\\x7f-\\uffff]/g:/[\\\\\\\"\\x00-\\x1f\\x7f-\\xff]/g;\nfunction Qa(a"
    ",b,c){c.push('\"',b.replace(Sa,function(d){if(d in Ra)return Ra[d];var g="
    "d.charCodeAt(0),e=\"\\\\u\";if(g<16)e+=\"000\";else if(g<256)e+=\"00\";el"
    "se if(g<4096)e+=\"0\";return Ra[d]=e+g.toString(16)}),'\"')};function X(a"
    "){switch(q(a)){case \"string\":case \"number\":case \"boolean\":return a;"
    "case \"function\":return a.toString();case \"array\":return na(a,X);case "
    "\"object\":a=a;if(\"nodeType\"in a&&(a.nodeType==1||a.nodeType==9)){var b"
    "={};b.ELEMENT=Ta(a);return b}if(aa(a))return na(a,X);a=ea(a,function(c,d)"
    "{return typeof d==\"number\"||s(d)});return fa(a,X);default:return null}}"
    "\nfunction Ua(a,b,c,d,g,e){function f(n,t){if(!r){r=true;Ka(l);h.clearTim"
    "eout(k);if(n!=y){var B=new z(n,t.message||t+\"\");B.stack=t.stack;t={stat"
    "us:\"code\"in B?B.code:13,value:{message:B.message}}}else t={status:y,val"
    "ue:X(t)};B=d;var C;if(g){C=[];Pa(new Oa,t,C);C=C.join(\"\")}else C=t;B(C)"
    "}}var h=e||window,k,l,r=false;e=da(f,13);if(h.closed)return e(\"Unable to"
    " execute script; the target window is closed.\");if(s(a))a=new Function(a"
    ");if(h!=window)a=h.eval(\"(\"+a+\")\");b.push(da(f,y));l=Ia(h,\"unload\","
    "function(){f(13,\nError(\"Detected a page unload event; asynchronous scri"
    "pt execution does not work across page loads.\"))},true);var m=v();try{a."
    "apply(h,b);k=h.setTimeout(function(){f(28,Error(\"Timed out waiting for a"
    "syncrhonous script result after \"+(v()-m)+\" ms\"))},Math.max(0,c))}catc"
    "h(i){f(i.code||13,i)}}function Va(a){a=a||document;var b=a.$wdc_;if(!b){b"
    "=a.$wdc_={};b.k=v()}if(!b.k)b.k=v();return b}function Ta(a){var b=Va(a.ow"
    "nerDocument),c=ga(b,function(d){return d==a});if(!c){c=\":wdc:\"+b.k++;b["
    "c]=a}return c};function Wa(a,b,c){Ua(a,b,c,function(d){window.location.hr"
    "ef=\"webdriver://executeAsyncScript?\"+d},window,true)}var Y=\"_\".split("
    "\".\"),Z=o;!(Y[0]in Z)&&Z.execScript&&Z.execScript(\"var \"+Y[0]);for(var"
    " $;Y.length&&($=Y.shift());)if(!Y.length&&Wa!==undefined)Z[$]=Wa;else Z=Z"
...
const char* const EXECUTE_SCRIPT =
    ...
    "ion a(){return{c:0,e:0}}function b(){return[]}function c(){function k(o){"
    "return g.call(k.src,k.key,o)}return k}function d(){return new va}function"
    " f(){return new H}var e=za&&!(ma(Aa,\"5.7\")>=0),g;N=function(k){g=k};if("
    "e){K=function(k){J(i,k)};L=function(){return xa(l)};M=function(k){J(l,k)}"
    ";O=function(){J(j,c())};P=function(k){J(s,k)};Q=function(){return xa(m)};"
    "R=function(k){J(m,k)};var i=new I(0,600);i.a=a;var l=new I(0,600);l.a=b;v"
    "ar j=new I(0,600);j.a=c;var s=new I(0,600);s.a=d;\nvar m=new I(0,600);m.a"
    ...
    "ar g=a.length;for(var i=0;i<g;i++){var l=a[i];if(l&&!l.f)e&=Ea(l,f)!==fal"
    ...
    "f.src,g=f.type,i=f.t,l=f.capture;if(e.removeEventListener){if(e==n||!e.B)"
    "e.removeEventListener(g,i,l)}else e.detachEvent&&e.detachEvent(Ca(g),i);e"
    "=t(e);i=T[g][l][e];if(U[e]){var j=U[e],s=na(j,f);if(s>=0){A(j.length!=nul"
    "l);B.splice.call(j,s,1)}j.length==0&&delete U[e]}f.f=true;i.s=true;Ba(g,l"
    ...
    "ed)D=false;if(D){var i;if(!(i=b))a:{i=\"window.event\".split(\".\");var l"
    "=n;for(;e=i.shift();)if(l[e]!=null)l=l[e];else{i=null;break a}i=l}e=i;i=t"
    "rue in f;l=false in f;if(i){if(e.keyCode<0||e.returnValue!=undefined)retu"
    "rn true;a:{var j=false;if(e.keyCode==0)try{e.keyCode=-1;break a}catch(s){"
    "j=true}if(j||e.returnValue==undefined)e.returnValue=true}}j=Q();j.i(e,thi"
    "s);e=true;try{if(i){var m=\nL();for(var k=j.currentTarget;k;k=k.parentNod"
    "e)m.push(k);g=f[true];g.e=g.c;for(var o=m.length-1;!j.l&&o>=0&&g.e;o--){j"
    ".currentTarget=m[o];e&=Da(g,m[o],d,true,j)}if(l){g=f[false];g.e=g.c;for(o"
    "=0;!j.l&&o<m.length&&g.e;o++){j.currentTarget=m[o];e&=Da(g,m[o],d,false,j"
    ")}}}else e=Ea(c,j)}finally{if(m){m.length=0;M(m)}j.g();R(j)}return e}d=ne"
    ...
    " Oa(a,b,c){var d;try{if(r(a))a=new Function(a);var f=La(b),e=a.apply(null"
    ",f);d={status:0,value:X(e)}}catch(g){d={status:\"code\"in g?g.code:13,val"
    "ue:{message:g.message}}}if(c){a=[];Ga(new Fa,d,a);d=a.join(\"\")}else d=d"
    ";return d}var Y=\"_\".split(\".\"),Z=n;!(Y[0]in Z)&&Z.execScript&&Z.execS"
    "cript(\"var \"+Y[0]);for(var $;Y.length&&($=Y.shift());)if(!Y.length&&Oa!"
    "==undefined)Z[$]=Oa;else Z=Z[$]?Z[$]:Z[$]={};; return this._.apply(null,a"
