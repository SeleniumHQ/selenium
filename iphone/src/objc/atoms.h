...
const char* const EXECUTE_ASYNC_SCRIPT =
    ...
    "all(this,la.apply(null,b));b.shift();this.D=a}w(E,x);E.prototype.name=\"A"
    ...
    "ype.B=true;new Function(\"a\",\"return a\");function L(a,b){a&&this.h(a,b"
    ...
    "this.A=pa?a.metaKey:a.ctrlKey;this.C=a.C;this.p=a;delete this.B;delete th"
    ...
    "ener){if(a==o||!a.z)a.addEventListener(b,e,d)}else a.attachEvent(Ka(b),\n"
    ...
    ".u,e=b.capture;if(c.removeEventListener){if(c==o||!c.z)c.removeEventListe"
    ...
    "turn new b.w(a);return b==window?a:new b.w(\"return (\"+a+\").apply(null,"
    "arguments);\")}\nfunction Ya(a,b,c,d,f,e){function g(n,t){if(!s){La(l);h."
    "clearTimeout(k);if(n!=y){var B=new z(n,t.message||t+\"\");B.stack=t.stack"
    ";t={status:\"code\"in B?B.code:13,value:{message:B.message}}}else t={stat"
    "us:y,value:X(t)};B=d;var C;if(f){C=[];Qa(new Pa,t,C);C=C.join(\"\")}else "
    "C=t;B(C);s=true}}var h=e||window,k,l,s=false;e=ea(g,13);if(h.closed)retur"
    "n e(\"Unable to execute script; the target window is closed.\");a=Xa(a,h)"
    ";b=Va(b,h.document);b.push(ea(g,y));l=Ja(h,\"unload\",function(){g(13,Err"
    "or(\"Detected a page unload event; asynchronous script execution does not"
    " work across page loads.\"))},\ntrue);var m=v();try{a.apply(h,b);k=h.setT"
    "imeout(function(){g(28,Error(\"Timed out waiting for asyncrhonous script "
    "result after \"+(v()-m)+\" ms\"))},Math.max(0,c))}catch(i){g(i.code||13,i"
    ")}}function Za(a){a=a||document;var b=a.$wdc_;if(!b){b=a.$wdc_={};b.k=v()"
    "}if(!b.k)b.k=v();return b}function Ua(a){var b=Za(a.ownerDocument),c=ha(b"
    ",function(d){return d==a});if(!c){c=\":wdc:\"+b.k++;b[c]=a}return c}\nfun"
    "ction Wa(a,b){a=decodeURIComponent(a);var c=b||document,d=Za(c);if(!(a in"
    " d))throw new z(10,\"Element does not exist in cache\");var f=d[a];for(va"
    "r e=f;e;){if(e==c.documentElement)return f;e=e.parentNode}delete d[a];thr"
    "ow new z(10,\"Element is no longer attached to the DOM\");};function $a(a"
    ",b,c){Ya(a,b,c,function(d){window.location.href=\"webdriver://executeAsyn"
    "cScript?\"+d},window,true)}var Y=\"_\".split(\".\"),Z=o;!(Y[0]in Z)&&Z.ex"
    "ecScript&&Z.execScript(\"var \"+Y[0]);for(var $;Y.length&&($=Y.shift());)"
    "if(!Y.length&&$a!==undefined)Z[$]=$a;else Z=Z[$]?Z[$]:Z[$]={};; return th"
...
const char* const EXECUTE_SCRIPT =
    ...
    "t();this.D=a}u(z,v);z.prototype.name=\"AssertionError\";function A(a,b){i"
    ...
    "ntTarget};G.prototype.l=false;G.prototype.A=true;new Function(\"a\",\"ret"
    ...
    ";h.altKey=false;h.shiftKey=false;h.metaKey=false;h.z=false;h.p=null;\nh.i"
    ...
    "tKey=a.shiftKey;this.metaKey=a.metaKey;this.z=pa?a.metaKey:a.ctrlKey;this"
    ".B=a.B;this.p=a;delete this.A;delete this.l};h.d=function(){H.u.d.call(th"
    ...
    "=!!f;this.w=e;this.m=false;this.key=++wa;this.f=false};h.handleEvent=func"
    "tion(a){if(this.q)return this.j.call(this.w||this.src,a);return this.j.ha"
    ...
    "f.src,g=f.type,i=f.t,j=f.capture;if(e.removeEventListener){if(e==n||!e.C)"
    ...
    " Oa(a,b,c,d){d=d||window;var f;try{var e=a;a=r(e)?new d.v(e):d==window?e:"
    "new d.v(\"return (\"+e+\").apply(null,arguments);\");var g=La(b,d.documen"
    "t),i=a.apply(null,g);f={status:0,value:X(i)}}catch(j){f={status:\"code\"i"
    "n j?j.code:13,value:{message:j.message}}}if(c){a=[];Ga(new Fa,f,a);f=a.jo"
    "in(\"\")}else f=f;return f}var Y=\"_\".split(\".\"),Z=n;!(Y[0]in Z)&&Z.ex"
    "ecScript&&Z.execScript(\"var \"+Y[0]);for(var $;Y.length&&($=Y.shift());)"
    "if(!Y.length&&Oa!==undefined)Z[$]=Oa;else Z=Z[$]?Z[$]:Z[$]={};; return th"
    "is._.apply(null,arguments);}.apply({navigator:typeof window!='undefined'?"
    "window.navigator:null}, arguments);}";
...
const char* const GET_TEXT =
    ...
    "c=Q(a,\"opacity\");if(c)b=Number(c);if(a=P(a))b*=U(a);return b};function "
    "ka(a){for(;a;){if(a.tagName&&a.tagName.toLowerCase()==\"head\")return tru"
    "e;try{a=a.parentNode}catch(b){return false}}return false};function X(a){i"
    "f(ka(a)){var b=F(a);if(a.tagName.toUpperCase()==\"TITLE\"&&(b?b.parentWin"
    "dow||b.defaultView:window)==m.top)return r(b.title);return\"\"}b=[];V(a,b"
    ");b=A(b,r);return r(b.join(\"\\n\"))}var Y=\"_\".split(\".\"),Z=h;!(Y[0]i"
    "n Z)&&Z.execScript&&Z.execScript(\"var \"+Y[0]);for(var $;Y.length&&($=Y."
    "shift());)if(!Y.length&&X!==undefined)Z[$]=X;else Z=Z[$]?Z[$]:Z[$]={};; r"
    "eturn this._.apply(null,arguments);}.apply({navigator:typeof window!='und"
