...
Section "MainSection" SEC01
  ...
  File "..\dist\cgi-bin\nph-proxy.cgi"
  File "..\dist\cgi-bin\nph-proxy.exe"
  File "..\dist\cgi-bin\selenium-compiling-perl-to-exe-README.txt"
  SetOutPath "$INSTDIR"
  File "..\dist\datetime.pyd"
  SetOutPath "$INSTDIR\examples"
  File "..\dist\examples\google-test-xmlrpc.pl"
  File "..\dist\examples\google-test-xmlrpc.py"
  File "..\dist\examples\google-test-xmlrpc.rb"
  File "..\dist\examples\run_firefox.bat"
  File "..\dist\examples\run_IE.bat"
  SetOutPath "$INSTDIR"
  ...
  File "..\dist\selenium_driver\tests\html\test_modal_dialog.html"
  File "..\dist\selenium_driver\tests\html\test_modal_dialog_dialog.html"
  ...
  File "..\dist\selenium_driver\tests\TestModalDialog.html"
  File "..\dist\selenium_driver\tests\TestModalDialogDialog.html"
  File "..\dist\selenium_driver\tests\TestModalDialogDialogTestSuite.html"
...
Section Uninstall
  ...
  Delete "$INSTDIR\selenium_driver\tests\TestModalDialogDialogTestSuite.html"
  Delete "$INSTDIR\selenium_driver\tests\TestModalDialogDialog.html"
  Delete "$INSTDIR\selenium_driver\tests\TestModalDialog.html"
  ...
  Delete "$INSTDIR\selenium_driver\tests\html\test_modal_dialog_dialog.html"
  Delete "$INSTDIR\selenium_driver\tests\html\test_modal_dialog.html"
  ...
  Delete "$INSTDIR\examples\run_IE.bat"
  Delete "$INSTDIR\examples\run_firefox.bat"
  Delete "$INSTDIR\examples\google-test-xmlrpc.rb"
  Delete "$INSTDIR\examples\google-test-xmlrpc.py"
  Delete "$INSTDIR\examples\google-test-xmlrpc.pl"
  Delete "$INSTDIR\datetime.pyd"
  Delete "$INSTDIR\cgi-bin\selenium-compiling-perl-to-exe-README.txt"
  Delete "$INSTDIR\cgi-bin\nph-proxy.exe"
  Delete "$INSTDIR\cgi-bin\nph-proxy.cgi"
  Delete "$INSTDIR\cgi-bin\CGIProxy-README.txt"
