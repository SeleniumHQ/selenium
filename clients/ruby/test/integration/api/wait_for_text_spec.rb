...
describe "Wait For (No) Text" do
  ...
  it "wait_for_text does not block when text is present" do
    ...
    page.wait_for_text "Prototype - Selenium Ruby Client Sample App", :element => "title"
  end
  
  it "wait_for_no_text does not block when element is not present" do
    page.open "http://localhost:4567/prototype.html"
