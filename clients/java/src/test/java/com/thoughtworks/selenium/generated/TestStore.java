 ...
 * Generated from //socrates/unixhome/nelsons/work/selenium-rc/trunk/javascript-core/src/selenium/tests/TestStore.html.
 */
public class TestStore extends SeleneseTestCase
{
   public void test() throws Throwable {
		selenium.setContext("Test store*", "info");
...
/* Test store and variations       */
		...
		/* backward compatibility */
			...
			// storeValue|openPageText|
			String openPageText = this.getText();
		...
		/* This new command should replace the old usage of storeValue */
			...
			// type|theText|${openPageText}
			selenium.type("theText", openPageText);
