...
public class DollarRentACarTest extends AbstractTest {
    ...
    public void searchAndRent() throws InterruptedException {
        ...
        selenium.select("ctl05_ctl01_ResStartColumnLayout_LocationTime_CarTypeDropDownList", "label=Intermediate");
        selenium.click("ctl05_ctl01_ResStartColumnLayout_LocationTime_GetRatesButton");
        selenium.waitForPageToLoad("30000");
        selenium.click("ctl05_ctl03_VehicleInformationColumnLayout_GoButton");
        selenium.waitForPageToLoad("30000");
        selenium.select("ctl05_ctl03_PersonalInformationColumnLayout_OptionsColumnLayout_LoyaltyProgramList", "label=Virgin Atlantic Flying Club");
        selenium.click("ctl05_ctl03_PersonalInformationColumnLayout_ReserveNowSitecoreImageButton");
