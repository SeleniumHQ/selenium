...
/**
 * A generic interface for waiting until a condition is true or not null. The
 * condition may take a single argument of type .
 *
...
public interface Wait<F> {
   ...
   * not be Void.
   *
   * <p>If the condition does not become true within a certain time (as defined
   * by the implementing class), this method will throw a non-specified
   * {@link Throwable}. This is so that an implementor may throw whatever is
   * idiomatic for a given test infrastructure (e.g. JUnit4 would throw {@link
   * AssertionError}.
   *
