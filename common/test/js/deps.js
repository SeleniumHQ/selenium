...
goog.addDependency("../../../js/src/selenium/script.js", ['core.script'], ['bot.script']);
...
goog.addDependency("../../../js/src/bot/script.js", ['bot.script'], ['bot.Error', 'bot.ErrorCode', 'goog.events', 'goog.events.EventType']);
goog.addDependency("../../../js/src/bot/events.js", ['bot.events'], ['bot.dom', 'goog.dom', 'goog.events.EventType', 'goog.userAgent']);
goog.addDependency("../../../js/src/bot/keys.js", ['bot.keys'], ['bot.Error', 'bot.ErrorCode', 'bot.action', 'bot.events', 'goog.dom.selection', 'goog.events.EventType', 'goog.events.KeyCodes', 'goog.userAgent']);
goog.addDependency("../../../js/src/bot/action.js", ['bot.action'], ['bot.Error', 'bot.ErrorCode', 'bot.dom', 'bot.events', 'goog.array', 'goog.dom', 'goog.dom.NodeType', 'goog.dom.TagName', 'goog.events.EventType', 'goog.userAgent', 'goog.Uri']);
...
goog.addDependency("../../../js/src/bot/locators/classname.js", ['bot.locators.className'], ['goog.array', 'goog.dom', 'goog.dom.DomHelper', 'goog.string']);
goog.addDependency("../../../js/src/bot/locators/css.js", ['bot.locators.css'], ['goog.array', 'goog.dom', 'goog.dom.NodeType', 'goog.object', 'goog.string', 'goog.userAgent']);
goog.addDependency("../../../js/src/bot/locators/link_text.js", ['bot.locators.linkText', 'bot.locators.partialLinkText'], ['bot', 'bot.dom', 'goog.array', 'goog.dom', 'goog.dom.DomHelper']);
goog.addDependency("../../../js/src/bot/locators/locators.js", ['bot.locators'], ['bot', 'bot.locators.className', 'bot.locators.css', 'bot.locators.id', 'bot.locators.linkText', 'bot.locators.name', 'bot.locators.partialLinkText', 'bot.locators.tagName', 'bot.locators.xpath', 'goog.array', 'goog.object']);
goog.addDependency("../../../js/src/bot/locators/xpath.js", ['bot.locators.xpath'], ['goog.array', 'goog.dom', 'goog.dom.xml']);
goog.addDependency("../../../js/src/bot/locators/id.js", ['bot.locators.id'], ['bot.dom', 'goog.array', 'goog.dom']);
goog.addDependency("../../../js/src/bot/locators/tag_name.js", ['bot.locators.tagName'], ['goog.array', 'goog.dom', 'goog.dom.DomHelper']);
goog.addDependency("../../../js/src/bot/locators/name.js", ['bot.locators.name'], ['bot.dom', 'goog.array', 'goog.dom']);
